...
import { emptyHeaderTitleFromIntl } from "@gooddata/sdk-ui";
import { valueWithEmptyHandling } from "@gooddata/sdk-ui-vis-commons";
import { ROW_SUBTOTAL, ROW_TOTAL } from "../base/constants";
import { isResultAttributeHeader, isResultTotalHeader } from "@gooddata/sdk-model";
...
function getCell(rowHeaderData, rowIndex, rowHeader, rowHeaderIndex, intl) {
    ...
    if (isResultAttributeHeader(rowHeaderDataItem)) {
        return __assign(__assign({}, cell), { value: valueWithEmptyHandling(rowHeaderDataItem.attributeHeaderItem.name, emptyHeaderTitleFromIntl(intl)) });
    }
