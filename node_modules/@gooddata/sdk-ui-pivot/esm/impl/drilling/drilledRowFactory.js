...
export function createDrilledRow(row, tableDescriptor) {
    ...
    tableDescriptor.headers.sliceCols.forEach(function (col) {
        ...
        var drillItemUri = (_a = getMappingHeaderUri(mappingHeader)) !== null && _a !== void 0 ? _a : null;
        var id = getDrillItemId(drillItemUri);
        switch (id) {
            case "":
...
function getDrillItemId(drillItemUri) {
    ...
    return (drillItemUri === null || drillItemUri === void 0 ? void 0 : drillItemUri.startsWith("/gdc")) ? extractIdsFromAttributeElementUri(drillItemUri)[1]
