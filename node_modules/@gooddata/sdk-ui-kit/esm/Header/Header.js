...
var AppHeaderCore = /** @class */ (function (_super) {
    ...
    function AppHeaderCore(props) {
        ...
        _this.getTrialCountdown = function (expiredDate) {
            var trialDaysLeft = differenceInCalendarDays(new Date(expiredDate), new Date());
            if (trialDaysLeft === 1) {
            ...
            if (trialDaysLeft > 30 && trialDaysLeft <= 91) {
                ...
                var currentDateWithoutTime = format(new Date(), "yyyy-MM-dd");
                var trialMonthsLeft = differenceInMonths(new Date(expiredDate), new Date(currentDateWithoutTime));
        ...
        _this.renderVerticalMenu = function () {
            ...
            var menuItemsGroups = !_this.state.isHelpMenuOpen
                ? _this.props.showStaticHelpMenu
                    ? [[_this.getHelpMenuLink()]]
        ...
        _this.renderStandardNav = function () {
            var _a = _this.props, badges = _a.badges, helpMenuDropdownAlignPoints = _a.helpMenuDropdownAlignPoints;
            return (React.createElement("div", { className: "gd-header-stretch gd-header-menu-wrapper" },
                ...
                _this.props.expiredDate && (React.createElement("div", { className: "gd-header-expiration-date" }, _this.getTrialCountdown(_this.props.expiredDate))),
                _this.props.showUpsellButton && (React.createElement(HeaderUpsellButton, { onUpsellButtonClick: _this.props.onUpsellButtonClick })),
                !!_this.props.helpMenuItems.length && (React.createElement(HeaderHelp, { onMenuItemClick: _this.props.onMenuItemClick, className: "gd-header-measure", helpMenuDropdownAlignPoints: helpMenuDropdownAlignPoints, items: _this.props.helpMenuItems, disableDropdown: _this.props.disableHelpDropdown, onHelpClicked: _this.props.onHelpClick, helpRedirectUrl: _this.props.helpRedirectUrl })),
                _this.props.showInviteItem && (React.createElement(HeaderInvite, { onInviteItemClick: _this.props.onInviteItemClick })),
