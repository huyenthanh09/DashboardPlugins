...
export function DropdownList(props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        !isLoading && itemsCount > 0 && (React.createElement(AutoSize, null, function (autoSize) {
            ...
            return (React.createElement(List, __assign({ className: listClassNames, width: listWidth, height: listHeight, items: items, itemsCount: itemsCount, itemHeight: isMobile ? Math.max(mobileItemHeight, itemHeight) : itemHeight, scrollToItem: scrollToItem }, listProps)));
        })),
        renderFooter()));
}
