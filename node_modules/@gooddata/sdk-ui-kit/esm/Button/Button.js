...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        var _this = this;
        var _a = this.props, id = _a.id, tagName = _a.tagName, title = _a.title, value = _a.value, tabIndex = _a.tabIndex, type = _a.type, iconLeft = _a.iconLeft, iconRight = _a.iconRight;
        var TagName = tagName;
        return (React.createElement(TagName, { id: id, ref: function (ref) {
    ...
    Button.prototype.getClassnames = function () {
        ...
        var generatedSeleniumClass = value && typeof value === "string" ? "s-" + stringUtils.simplifyText(value) : "";
        return cx((_a = {},
