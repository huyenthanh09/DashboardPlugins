...
var StylingSettingWidgetCore = function (props) {
    var title = props.title, defaultItem = props.defaultItem, customItems = props.customItems, itemToColorPreview = props.itemToColorPreview, emptyMessage = props.emptyMessage, selectedItemRef = props.selectedItemRef, isLoading = props.isLoading, titleTooltip = props.titleTooltip, footerHelpLink = props.footerHelpLink, footerHelpTitle = props.footerHelpTitle, footerMobileMessage = props.footerMobileMessage, onApply = props.onApply, onListActionClick = props.onListActionClick, onItemEdit = props.onItemEdit, onItemDelete = props.onItemDelete, className = props.className, onHelpClick = props.onHelpClick, _a = props.onItemSelect, onItemSelect = _a === void 0 ? noop : _a, onItemMenuToggle = props.onItemMenuToggle;
    var intl = useIntl();
    ...
    var showFooterButtons = useMemo(function () { return customItems.length > 0; }, [customItems]);
    ...
    return (React.createElement(SettingWidget, { className: cx("s-styling-picker", className) },
        ...
        React.createElement(Footer, null,
            isMobileDevice && footerMobileMessage && (React.createElement(Message, { className: "gd-styling-picker-footer-message", type: "progress" }, footerMobileMessage)),
            footerHelpLink && footerHelpTitle && (React.createElement(Hyperlink, { text: footerHelpTitle, href: footerHelpLink, iconClass: "gd-icon-circle-question", onClick: onHelpClick })),
            showFooterButtons && (React.createElement(FooterButtons, null,
                React.createElement(Button, { className: "gd-button-secondary", onClick: handleCancel, disabled: isApplyButtonDisabled, value: intl.formatMessage({ id: "cancel" }) }),
                React.createElement(Button, { className: "gd-button-action", onClick: handleApply, disabled: isApplyButtonDisabled, value: intl.formatMessage({ id: "apply" }) }))))));
};
/**
 * @internal
 */
