...
var PortalIfTopLevelMenu = function (_a) {
    ...
    return topLevelMenu ? (React.createElement(RenderChildrenInPortal, { targetElement: portalTarget }, children)) : (React.createElement(React.Fragment, null, children));
};
    ...
    MenuPosition.prototype.render = function () {
        ...
        return (React.createElement(MaybeWrapper, null,
            ...
            React.createElement(PortalIfTopLevelMenu, { portalTarget: portalTarget, topLevelMenu: topLevelMenu }, opened && this.state.togglerElInitialized && (React.createElement(ContentWrapper, null,
                React.createElement(PositionedMenuContent, { alignment: alignment, spacing: spacing, offset: offset, topLevelMenu: topLevelMenu, togglerEl: this.togglerEl }, children))))));
    };
