...
export function InvertableSelectAllCheckbox(props) {
    var isVisible = props.isVisible, checked = props.checked, onToggle = props.onToggle, isFiltered = props.isFiltered, totalItemsCount = props.totalItemsCount, isPartialSelection = props.isPartialSelection;
    var intl = useIntl();
    var handleToggle = useCallback(function (_e) {
        onToggle();
    }, [onToggle]);
