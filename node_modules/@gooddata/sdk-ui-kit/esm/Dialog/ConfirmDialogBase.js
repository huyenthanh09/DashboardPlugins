            ...
            React.createElement("div", { className: dialogClasses },
                ...
                React.createElement("div", { className: "gd-dialog-header-wrapper" }, headerLeftButtonRenderer === null || headerLeftButtonRenderer === void 0 ? void 0 :
                    ...
                    React.createElement("div", { className: headerClassNames },
                        React.createElement("h3", { className: "gd-dialog-header-title" }, headline), titleRightIconRenderer === null || titleRightIconRenderer === void 0 ? void 0 :
                ...
                React.createElement("div", { className: "gd-dialog-footer" }, footerLeftRenderer === null || footerLeftRenderer === void 0 ? void 0 :
                    footerLeftRenderer(),
                    showProgressIndicator && React.createElement(LoadingSpinner, { className: "gd-dialog-spinner small" }),
                    ...
                    submitButtonText && (React.createElement(BubbleHoverTrigger, { className: "gd-button", showDelay: 0, hideDelay: 0 },
                        ...
                        submitButtonTooltipText && (React.createElement(Bubble, { className: "bubble-primary", alignPoints: submitButtonTooltipAlignPoints || [{ align: "bc tc" }], arrowOffsets: submitButtonTooltipArrowOffsets || { "bc tc": [0, 15] } }, submitButtonTooltipText))))))));
    };
