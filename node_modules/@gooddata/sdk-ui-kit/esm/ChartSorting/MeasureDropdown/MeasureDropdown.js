...
export var MeasureDropdown = function (_a) {
    var currentItem = _a.currentItem, availableSorts = _a.availableSorts, bucketItems = _a.bucketItems, intl = _a.intl, onSelect = _a.onSelect, index = _a.index, enableRenamingMeasureToMetric = _a.enableRenamingMeasureToMetric, disabledExplanationTooltip = _a.disabledExplanationTooltip;
    ...
    var items = getItems(intl, measures, bucketItems, areaSortEnabled, availableSorts.itemId);
    var disableDropdown = items.length === 1;
    var buttonValue = getButtonValue(currentItem, intl, bucketItems);
    ...
    return (React.createElement("div", { className: "sort-measure-section" },
        ...
        React.createElement("div", { className: "measure-sorting-dropdown" }, disableDropdown ? (React.createElement(BubbleHoverTrigger, null,
            ...
            disabledExplanationTooltip && (React.createElement(Bubble, { alignPoints: [{ align: "cr cl" }, { align: "cl cr" }] })))) : (React.createElement(Dropdown, { className: "gd-measure-sorting-dropdown-body s-measure-sorting-dropdown-body", closeOnMouseDrag: true, closeOnParentScroll: true, renderButton: function (_a) {
                var isOpen = _a.isOpen, toggleDropdown = _a.toggleDropdown;
                return (React.createElement("div", { ref: buttonRef },
                    React.createElement(DropdownButton, { className: "s-sort-type-measure-button s-measure-dropdown-button-" + index, value: measureName, isOpen: isOpen, disabled: disableDropdown, onClick: toggleDropdown, iconLeft: getMeasureIconClassNameBySelected(buttonValue.id, enableRenamingMeasureToMetric) })));
                ...
                return (React.createElement(DropdownList, { width: width, items: items, className: "gd-measure-sorting-dropdown-body s-measure-sorting-dropdown-body", renderItem: function (_a) {
                        var item = _a.item, rowIndex = _a.rowIndex;
