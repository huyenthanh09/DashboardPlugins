...
function getLeafPoint(stackByAttribute, parentIndex, seriesIndex, data, format, colorStrategy, emptyHeaderTitle) {
    return {
        name: valueWithEmptyHandling(stackByAttribute.items[seriesIndex].attributeHeaderItem.name, emptyHeaderTitle),
        parent: "" + parentIndex,
...
stackByAttribute, colorStrategy, emptyHeaderTitle) {
    ...
    dv.rawData()
        ...
        var unsortedLeafs = seriesItems.map(function (seriesItem, seriesItemIndex) {
            return {
                name: valueWithEmptyHandling(stackByAttribute.items[seriesItemIndex].attributeHeaderItem.name, emptyHeaderTitle),
                parent: "" + seriesIndex,
...
export function getTreemapStackedSeries(dv, measureGroup, viewByAttribute, stackByAttribute, colorStrategy, emptyHeaderTitle) {
    ...
    var seriesName = measureGroup.items.map(function (wrappedMeasure) { return unwrap(wrappedMeasure).name; }).join(", ");
    return [
        {
