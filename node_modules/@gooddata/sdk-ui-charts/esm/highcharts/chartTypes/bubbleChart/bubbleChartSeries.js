...
function getCountOfEmptyBuckets(bucketEmptyFlags) {
    ...
    return bucketEmptyFlags.filter(function (bucketEmptyFlag) { return bucketEmptyFlag; }).length;
}
    ...
    return dv
        ...
        return {
            name: stackByAttribute
                ? valueWithEmptyHandling(stackByAttribute.items[index].attributeHeaderItem.name, emptyHeaderTitle)
                : "",
