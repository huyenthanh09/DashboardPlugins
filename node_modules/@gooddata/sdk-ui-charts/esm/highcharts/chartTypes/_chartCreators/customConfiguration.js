...
import { formatAsPercent, getLabelStyle, getLabelsVisibilityConfig, getTotalsVisibilityConfig, getTotalsVisibility, } from "./dataLabelsHelpers";
...
import { isAreaChart, isBarChart, isBubbleChart, isBulletChart, isColumnChart, isComboChart, isHeatmap, isInvertedChartType, isOneOfTypes, isRotationInRange, isScatterPlot, isSupportingJoinedAttributeAxisName, percentFormatter, } from "../_util/common";
...
var BAR_WIDTH_WHEN_TOTAL_LABELS_AVAILABLE = "90%";
var escapeAngleBrackets = function (str) { return str === null || str === void 0 ? void 0 : str.replace(/</g, "&lt;").replace(/>/g, "&gt;"); };
...
function getLabelsConfiguration(chartOptions, _config, chartConfig) {
    ...
    var _e = chartConfig || {}, _f = _e.stackMeasuresToPercent, stackMeasuresToPercent = _f === void 0 ? false : _f, _g = _e.enableSeparateTotalLabels, enableSeparateTotalLabels = _g === void 0 ? false : _g;
    ...
    var totalsVisible = isBarChart(type) && !enableSeparateTotalLabels ? false : getTotalsVisibility(chartConfig);
...
function getStackingConfiguration(chartOptions, _config, chartConfig) {
    ...
    var totalLabelsConfig = getTotalsVisibilityConfig(type, chartConfig);
    var yAxis = yAxes.map(function () { return ({
        stackLabels: __assign(__assign({}, totalLabelsConfig), { formatter: partial(stackLabelFormatter, chartConfig) }),
    }); });
    var connectNulls = isAreaChart(type) ? { connectNulls: true } : {};
    // extra space allocation for total labels if available
    var totalsVisibleByLabelsConfig = isNil((_a = chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.dataLabels) === null || _a === void 0 ? void 0 : _a.totalsVisible) && !!((_b = chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.dataLabels) === null || _b === void 0 ? void 0 : _b.visible);
    var totalLabelsExtention = isBarChart(type) && (chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.enableSeparateTotalLabels) &&
        ...
        ? {
            chart: { marginRight: 0 },
            yAxis: yAxis.map(function (element) {
                return __assign(__assign({}, element), { width: BAR_WIDTH_WHEN_TOTAL_LABELS_AVAILABLE });
            }),
        }
        : {};
    return __assign({ plotOptions: {
            series: __assign({ stacking: stacking }, connectNulls),
        }, yAxis: yAxis }, totalLabelsExtention);
}
...
var getXAxisConfiguration = function (chartOptions, chartConfig, axisValueColor, axisLabelColor) {
    ...
    return xAxes.map(function (axis) {
        ...
        var minRange = ((_l = chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.zoomInsight) !== null && _l !== void 0 ? _l : false) && ((_o = (_m = chartOptions === null || chartOptions === void 0 ? void 0 : chartOptions.data) === null || _m === void 0 ? void 0 : _m.categories) !== null && _o !== void 0 ? _o : []).length > 2
            ? MIN_RANGE
            : undefined;
        var joinedAttributeAxisName = (chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.enableJoinedAttributeAxisName) && isSupportingJoinedAttributeAxisName(type);
        var titleTextProp = visible && (!isViewByTwoAttributes || joinedAttributeAxisName) ? {} : { text: null }; // new way how to hide title instead of deprecated 'enabled'
...
function getReversedStacking(chartOptions, _config, chartConfig) {
    var hasAnyStackOptionSelected = (chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.stackMeasures) || (chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.stackMeasuresToPercent) || (chartOptions === null || chartOptions === void 0 ? void 0 : chartOptions.hasStackByAttribute);
    var shouldReverseStacking = isBarChart(chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.type) && (chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.enableReversedStacking) && hasAnyStackOptionSelected;
    return {
        yAxis: [
            {
