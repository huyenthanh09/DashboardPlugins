...
import { getPrimaryChartType, isInvertedChartType, isColumnChart, isComboChart, isLineChart, isBarChart, } from "../_util/common";
...
export function getYAxisConfiguration(chartOptions, config, chartConfig) {
    ...
    var stackingDataLabelEnabled = getTotalsVisibilityConfig(type, chartConfig).enabled;
    var yAxisWithStackLabel = yAxis.map(function (axis, index) {
        ...
        var stackLabelEnabled = (index !== 0 || !stackMeasuresToPercent) && !!stackingDataLabelEnabled;
