...
declare type ChartedAttributes = {
    viewByAttribute?: IUnwrappedAttributeHeadersWithItems;
    viewByParentAttribute?: IUnwrappedAttributeHeadersWithItems;
    stackByAttribute?: IUnwrappedAttributeHeadersWithItems;
    isViewByTwoAttributes?: boolean;
};
export declare function getChartOptions(dataView: IDataView, chartConfig: IChartConfig, drillableItems: IHeaderPredicate[], emptyHeaderTitle: string, theme?: ITheme): IChartOptions;
export {};
