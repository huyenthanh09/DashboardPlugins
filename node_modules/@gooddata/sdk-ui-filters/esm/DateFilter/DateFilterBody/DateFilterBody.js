...
var DateFilterBody = /** @class */ (function (_super) {
    ...
    function DateFilterBody() {
        ...
        _this.renderAbsoluteForm = function () {
            var _a = _this.props, dateFormat = _a.dateFormat, filterOptions = _a.filterOptions, selectedFilterOption = _a.selectedFilterOption, onSelectedFilterOptionChange = _a.onSelectedFilterOptionChange, isTimeForAbsoluteRangeEnabled = _a.isTimeForAbsoluteRangeEnabled, isMobile = _a.isMobile, errors = _a.errors;
            ...
            return (React.createElement(React.Fragment, null,
                ...
                isSelected && (!isMobile || isOnRoute) && (React.createElement(DateFilterFormWrapper, { isMobile: isMobile },
                    React.createElement(AbsoluteDateFilterForm, { dateFormat: dateFormat, errors: (errors === null || errors === void 0 ? void 0 : errors.absoluteForm) || undefined, onSelectedFilterOptionChange: onSelectedFilterOptionChange, selectedFilterOption: selectedFilterOption, isMobile: isMobile, isTimeEnabled: isTimeForAbsoluteRangeEnabled })))));
        };
            ...
            React.createElement("div", { className: cx("gd-extended-date-filter-body", "s-extended-date-filters-body", isMobile && "gd-extended-date-filter-body-mobile") },
                ...
                React.createElement("div", { className: cx("gd-extended-date-filter-actions") },
                    React.createElement("div", { className: "gd-extended-date-filter-actions-buttons" },
                        React.createElement(DateFilterBodyButton, { messageId: "cancel", className: "gd-button-secondary gd-button-small s-date-filter-cancel", onClick: function () {
                                onCancelClick();
                                closeDropdown();
                            } }),
                        React.createElement(DateFilterBodyButton, { messageId: "apply", className: "gd-button-action gd-button-small s-date-filter-apply", disabled: !isEmpty(errors), onClick: function () {
                                onApplyClick();
                                closeDropdown();
                            } }))))));
    };
