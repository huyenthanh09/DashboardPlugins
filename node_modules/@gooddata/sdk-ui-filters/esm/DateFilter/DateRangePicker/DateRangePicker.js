...
var DateRangePickerComponent = /** @class */ (function (_super) {
    ...
    function DateRangePickerComponent(props) {
        ...
        _this.handleRangeSelect = function (range) {
            var calculatedFrom;
            var calculatedTo;
            if (!range) {
                // range undefined: when reaching same date by "to" field
                calculatedFrom = _this.props.range.from;
                calculatedTo = _this.setTimeForDate(_this.props.range.from, _this.props.range.to);
            }
            else if (!range.to) {
                // range.to undefined: when reaching same date by "from" field
                calculatedFrom = _this.setTimeForDate(_this.props.range.to, _this.props.range.from);
                calculatedTo = _this.props.range.to;
            }
            else {
                // distinct from/to dates
                var selectedInput = _this.state.selectedInput;
                if (selectedInput === "from") {
                    ...
                    var isResultInToField = _this.props.range.from.getTime() === range.from.getTime();
                    calculatedFrom = isResultInToField
                        ? _this.setTimeForDate(range.to, _this.props.range.from)
                        : _this.setTimeForDate(range.from, _this.props.range.from);
                    calculatedTo = _this.props.range.to;
                }
                else {
                    var isResultInToField = _this.props.range.from.getTime() === range.from.getTime();
                    ...
                    calculatedTo = isResultInToField
                        ? _this.setTimeForDate(range.to, _this.props.range.to)
                        : _this.setTimeForDate(range.from, _this.props.range.from);
                }
            }
            _this.setState({
    ...
    DateRangePickerComponent.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            isTimeEnabled ? (React.createElement("div", { className: "gd-date-range-picker datetime s-date-range-picker" },
                ...
                ToField,
                isToInputDatePickerOpen && DatePicker)) : (React.createElement(React.Fragment, null,
