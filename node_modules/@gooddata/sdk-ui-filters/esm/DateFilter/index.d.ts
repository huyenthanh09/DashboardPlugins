...
export { IDateAndMessageTranslator, IDateTranslator, IMessageTranslator, } from "./utils/Translations/Translators";
import { DateFilter, IDateFilterCallbackProps, IDateFilterOwnProps, IDateFilterProps, IDateFilterState, IDateFilterStatePropsIntersection } from "./DateFilter";
/**
 * @beta
 */
declare const DateFilterHelpers: {
    ...
    granularityIntlCodes: {
        ...
        "GDC.time.hour": import("./constants/i18n").GranularityIntlKey;
        "GDC.time.minute": import("./constants/i18n").GranularityIntlKey;
    };
    ...
    formatRelativeDateRange: (from: number, to: number, granularity: import("@gooddata/sdk-model").DateFilterGranularity, translator: import("./utils/Translations/Translators").IDateAndMessageTranslator) => string;
