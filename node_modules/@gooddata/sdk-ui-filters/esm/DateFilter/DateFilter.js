...
var DateFilter = /** @class */ (function (_super) {
    ...
    DateFilter.prototype.render = function () {
        var _a = this.props, customFilterName = _a.customFilterName, dateFilterMode = _a.dateFilterMode, dateFormat = _a.dateFormat, filterOptions = _a.filterOptions, originalSelectedFilterOption = _a.selectedFilterOption, originalExcludeCurrentPeriod = _a.excludeCurrentPeriod, availableGranularities = _a.availableGranularities, isEditMode = _a.isEditMode, locale = _a.locale, isTimeForAbsoluteRangeEnabled = _a.isTimeForAbsoluteRangeEnabled;
