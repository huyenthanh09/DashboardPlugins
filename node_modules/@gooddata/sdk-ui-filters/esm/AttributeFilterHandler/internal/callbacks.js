...
import { actions, selectInvertableCommittedSelection, selectInvertableWorkingSelection, } from "./redux";
var newCallbackRegistrations = function () {
    return {
        // Init
...
var newCallbackRegistrationsWithGlobalUnsubscribe = function () {
    var registeredCallbacks = [];
    var registrations = newCallbackRegistrations();
    var registerCallback = function (cb, registerFn) {
        var registeredCallback = registerFn.subscribe(cb);
        registeredCallbacks.push(registeredCallback);
        return registeredCallback;
    };
    var unsubscribeAll = function () {
        registeredCallbacks.forEach(function (unsubscribe) {
            unsubscribe();
        });
    };
    return {
 ...
 * @internal
 */
export var newAttributeFilterCallbacks = function () {
    var _a = newCallbackRegistrationsWithGlobalUnsubscribe(), registerCallback = _a.registerCallback, registrations = _a.registrations, unsubscribeAll = _a.unsubscribeAll;
    var eventListener = function (action, select) {
        // Init
        ...
        ].some(function (m) { return m(action); })) {
...
function newCallbackHandler() {
    ...
    var subscribe = function (cb) {
        ...
        return function unsubscribe() {
            subscribers = subscribers.filter(function (i) { return i != cb; });
        };
    };
    var invoke = function (payload) {
        subscribers.forEach(function (cb) { return cb(payload); });
    };
    return {
        invoke: invoke,
        subscribe: subscribe,
