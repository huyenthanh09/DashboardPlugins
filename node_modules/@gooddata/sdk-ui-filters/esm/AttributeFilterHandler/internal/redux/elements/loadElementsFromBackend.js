...
export function loadElementsFromBackend(context, options, hiddenElementsInfo) {
    return __awaiter(this, void 0, void 0, function () {
        var backend, workspace, displayFormRef, elements, limit, limitingAttributeFilters, limitingDateFilters, limitingMeasures, offset, search, order, includeTotalCountWithoutFilters, _a, excludePrimaryLabel, isInitialSelectionRequest, resolvedElements, loader, loaderOptions, effectiveLimitingAttributeFilters;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    backend = context.backend, workspace = context.workspace;
                    displayFormRef = options.displayFormRef, elements = options.elements, limit = options.limit, limitingAttributeFilters = options.limitingAttributeFilters, limitingDateFilters = options.limitingDateFilters, limitingMeasures = options.limitingMeasures, offset = options.offset, search = options.search, order = options.order, includeTotalCountWithoutFilters = options.includeTotalCountWithoutFilters, _a = options.excludePrimaryLabel, excludePrimaryLabel = _a === void 0 ? true : _a;
