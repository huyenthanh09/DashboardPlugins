...
export var AttributeFilterElementsSelect = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(InvertableSelect, { className: "gd-attribute-filter-elements-select__next", adaptiveWidth: true, adaptiveHeight: isMobile && fullscreenOnMobile, items: items, totalItemsCount: totalItemsCountWithCurrentSettings, itemHeight: itemHeight, getItemKey: getElementKey, getItemTitle: function (item) {
