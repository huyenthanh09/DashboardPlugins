 ...
 * @beta
 */
export var AttributeFilterSimpleDropdownButton = function (props) {
    var isOpen = props.isOpen, title = props.title, isLoading = props.isLoading, isFiltering = props.isFiltering, onClick = props.onClick;
    var intl = useIntl();
 ...
 * @beta
 */
export var AttributeFilterSimpleDropdownButtonWithSelection = function (props) {
    var isOpen = props.isOpen, subtitle = props.subtitle, title = props.title, selectedItemsCount = props.selectedItemsCount, onClick = props.onClick, isLoading = props.isLoading, isFiltering = props.isFiltering;
    var intl = useIntl();
    var buttonTitle = title + ": " + subtitle;
    if (isLoading || isFiltering) {
        buttonTitle = intl.formatMessage({ id: "loading" });
    }
    var buttonClassNames = cx("gd-button-primary", "button-dropdown", "dropdown-button", "gd-button-small", "gd-button", { "is-dropdown-open": isOpen }, { "is-active": isOpen });
    var icoClassNames = cx("gd-button-icon", { "gd-icon-navigateup": isOpen }, { "gd-icon-navigatedown": !isOpen });
    var selectionSize = selectedItemsCount !== 0 ? "(" + selectedItemsCount + ")" : undefined;
        ...
        React.createElement("button", { className: buttonClassNames, onClick: onClick, title: buttonTitle },
            React.createElement("span", { className: "gd-button-text" },
                React.createElement("div", { className: "gd-attribute-filter-dropdown-simple-button-text" },
                    ...
                    selectionSize && (React.createElement("div", { className: "gd-attribute-filter-dropdown-simple-button-selection-count" }, selectionSize)))),
