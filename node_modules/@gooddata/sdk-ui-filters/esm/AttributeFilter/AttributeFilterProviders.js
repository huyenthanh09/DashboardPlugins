 ...
 * @internal
 */
export var AttributeFilterProviders = function (props) {
    var children = props.children, locale = props.locale, backend = props.backend, workspace = props.workspace, title = props.title, filter = props.filter, connectToPlaceholder = props.connectToPlaceholder, identifier = props.identifier, parentFilters = props.parentFilters, parentFilterOverAttribute = props.parentFilterOverAttribute, hiddenElements = props.hiddenElements, staticElements = props.staticElements, _a = props.fullscreenOnMobile, fullscreenOnMobile = _a === void 0 ? false : _a, onApply = props.onApply, onError = props.onError, ErrorComponent = props.ErrorComponent, LoadingComponent = props.LoadingComponent, DropdownButtonComponent = props.DropdownButtonComponent, DropdownBodyComponent = props.DropdownBodyComponent, DropdownActionsComponent = props.DropdownActionsComponent, ElementsSearchBarComponent = props.ElementsSearchBarComponent, ElementsSelectComponent = props.ElementsSelectComponent, ElementsSelectItemComponent = props.ElementsSelectItemComponent, ElementsSelectErrorComponent = props.ElementsSelectErrorComponent, ElementsSelectLoadingComponent = props.ElementsSelectLoadingComponent, ElementsSelectActionsComponent = props.ElementsSelectActionsComponent, EmptyResultComponent = props.EmptyResultComponent, StatusBarComponent = props.StatusBarComponent;
