...
.gd-attribute-display-form-dropdown .gd-attribute-filter-display-form-button:active, .gd-attribute-display-form-dropdown .gd-attribute-filter-display-form-button.is-active {
  border: 1px solid var(--gd-palette-complementary-4, rgba(31, 52, 73, 0.2));
  box-shadow: inset 0 1px 0 0 var(--gd-shadow-color, rgba(177, 193, 209, 0.65));
  background-image: linear-gradient(-179deg, var(--gd-palette-complementary-2, #dee6ef) 0%, var(--gd-palette-complementary-2, #ecf0f5) 100%);
}
...
/*# sourceMappingURL=attributeFilterAddons.css.map */
