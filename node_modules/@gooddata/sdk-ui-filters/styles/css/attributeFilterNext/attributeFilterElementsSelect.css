...
.gd-attribute-filter-elements-select__next.gd-list .gd-list-item:hover {
  background-color: var(--gd-palette-complementary-2, #ebeff4);
}
.gd-attribute-filter-elements-select__next.gd-list .gd-list-item:hover.is-selected {
  color: var(--gd-palette-complementary-8, #464e56);
  background-color: var(--gd-palette-primary-dimmed, #e8f7fc);
}
.gd-attribute-filter-elements-select__next.gd-list .gd-list-item:hover .input-label-text {
  color: var(--gd-palette-complementary-9, inherit);
}
.gd-attribute-filter-elements-select__next.gd-list .gd-list-item.is-selected {
  font-weight: bold;
  color: var(--gd-palette-complementary-8, #464e56);
}

/*# sourceMappingURL=attributeFilterElementsSelect.css.map */
