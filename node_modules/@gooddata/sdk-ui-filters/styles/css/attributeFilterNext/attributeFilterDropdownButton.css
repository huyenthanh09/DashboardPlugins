...
.gd-attribute-filter-dropdown-button__next::before, .gd-attribute-filter-dropdown-button__next::after {
  content: "";
  position: absolute;
  transition: all 0.2s;
}
.gd-attribute-filter-dropdown-button__next::before {
  z-index: 1;
  top: 8px;
  left: 9px;
  width: 7px;
...
.gd-attribute-filter-dropdown-button__next:hover.gd-is-draggable::before {
  opacity: 1;
}
...
.gd-attribute-filter-dropdown-button__next:active.gd-is-draggable::before, .gd-attribute-filter-dropdown-button__next.gd-is-active.gd-is-draggable::before {
  opacity: 1;
}
...
.gd-attribute-filter-dropdown-button__next:active .gd-attribute-filter-dropdown-button-title__next::after,
.gd-attribute-filter-dropdown-button__next:active .gd-attribute-filter-dropdown-button-subtitle__next::after, .gd-attribute-filter-dropdown-button__next.gd-is-active .gd-attribute-filter-dropdown-button-title__next::after,
...
.gd-is-mobile .gd-attribute-filter-dropdown-button__next.gd-is-active .gd-attribute-filter-dropdown-button-subtitle__next::after {
  right: 0;
}
...
.gd-attribute-filter-button-mobile__next.gd-is-active .gd-attribute-filter-dropdown-button-title__next::after,
.gd-attribute-filter-button-mobile__next.gd-is-active .gd-attribute-filter-dropdown-button-subtitle__next::after {
  content: "\e613";
  position: absolute;
  top: 50%;
  right: -20px;
...
.overlay .gd-attribute-filter-dropdown-button-title__next {
  flex: 0 0 auto;
  max-width: 100%;
  margin-right: 5px;
  color: var(--gd-palette-complementary-7, #6d7680);
}
.overlay .gd-attribute-filter-dropdown-button-title__next::after {
  content: ":";
}
...
.gd-attribute-filter-dropdown-button-title__next:only-child::after,
...
.overlay .gd-attribute-filter-dropdown-button-subtitle__next::after {
  position: absolute;
  top: 50%;
  right: -20px;
  font-size: 18px;
...
/*# sourceMappingURL=attributeFilterDropdownButton.css.map */
