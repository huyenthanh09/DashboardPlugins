...
.gd-date-filter-button:hover::after, .drag-preview .gd-date-filter-button::after {
...
.gd-date-range-picker-dash + .gd-date-range-picker-to .gd-date-range-picker-picker {
  left: -143px;
}
...
.gd-date-range-picker-input-error input, .gd-date-range-picker-input-error input:hover, .gd-date-range-picker-input-error input:focus {
  border-color: var(--gd-palette-warning-base, #fada23);
}
...
.gd-extended-date-filter-body-mobile .gd-extended-date-filter-exclude-current, .gd-extended-date-filter-body-mobile .gd-extended-date-filter-actions {
  background-color: var(--gd-palette-complementary-0, #fff);
}
...
/*# sourceMappingURL=dateFilter.css.map */
