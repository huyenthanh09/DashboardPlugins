...
import { isAnalyticalBackendError, NotAuthenticated, UnexpectedError, LimitReached, ContractExpired, } from "@gooddata/sdk-backend-spi";
export function convertApiError(error) {
    ...
    var limitReached = createLimitReachedError(error);
    if (limitReached) {
        throw limitReached;
    }
    var contractExpired = createContractExpiredError(error);
    if (contractExpired) {
