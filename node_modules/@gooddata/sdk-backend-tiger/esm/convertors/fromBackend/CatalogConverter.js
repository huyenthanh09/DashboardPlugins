...
var tigerLabelToDisplayFormMd = function (label) {
    return newAttributeDisplayFormMetadataObject(idRef(label.id, "displayForm"), function (builder) {
        var _a;
        var labelBuilder = commonMetadataObjectModifications(label)(builder);
