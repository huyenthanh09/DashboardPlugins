...
function convertAttributeLabels(attribute, labelsMap) {
    ...
    var defaultView = (_d = (_c = attribute.relationships) === null || _c === void 0 ? void 0 : _c.defaultView) === null || _d === void 0 ? void 0 : _d.data;
    return labelsRefs
        .map(function (ref) {
        var _a;
        ...
        var isDefault = defaultView ? defaultView.id === label.id : !!((_a = label.attributes) === null || _a === void 0 ? void 0 : _a.primary);
