...
import { isAttributeAreaSort, isAttributeLocator, isAttributeSort, MeasureGroupIdentifier, } from "@gooddata/sdk-model";
...
function extractItemValueFromElement(elementUri) {
    ...
    var parsedUri = elementUri === null || elementUri === void 0 ? void 0 : elementUri.match(/obj\/([^/]*)(\/elements\?id=)?(.*)$/);
...
function dimensionsWithSorts(dims, sorts) {
    ...
    sorts.forEach(function (sortItem) {
        ...
        if (isAttributeSort(sortItem)) {
            ...
            var direction = convertSortDirection(sortItem.attributeSortItem.direction);
            var attributeSortKey = {
                attribute: __assign(__assign({ attributeIdentifier: attributeIdentifier_1 }, (direction !== SortKeyAttributeAttributeDirectionEnum.ASC ? { direction: direction } : {})), { sortType: convertAttributeSortType(sortItem) }),
            };
