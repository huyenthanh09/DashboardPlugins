...
export var DefaultUiSettings = __assign((_a = { activeFiltersByDefault: true, enableActiveFilterContext: true, cellMergedByDefault: true, enableMetricDateFilter: true, enableAnalyticalDesignerExport: true, enableNewADFilterBar: true, enableMeasureValueFilters: true, 
        ...
        // drilling
        enableKPIDashboardDrillToDashboard: true, enableKPIDashboardDrillToInsight: true, enableKPIDashboardDrillToURL: true, enableKPIDashboardImplicitDrillDown: false, enableKPIDashboardDrillFromAttribute: false, 
        // TNT-1096 Temporary disable for P8.
        enableDrilledInsightExport: false, enableFilterValuesResolution: false, enableClickableAttributeURL: true, enableNewNavigationForResponsiveUi: true, enableDataSection: true, ADCatalogGroupsExpanded: true, enableCustomColorPicker: true, enableAdAdditionalDateAttributes: true, enableAlternativeDisplayFormSelection: true, enableNewAnalyticalDashboardsNavigation: true, enableAnalyticalDashboardPermissions: false, 
        // enable the plugin-ready Dashboard component in gdc-dashboards
        dashboardComponentDevRollout: true, enableRenamingProjectToWorkspace: true, enableRenamingMeasureToMetric: true, enableAxisLabelFormat: true, enableChartsSorting: true, enableAxisNameViewByTwoAttributes: true, enableAxisNameConfiguration: true, enableDataSourceManagement: true, enableAdFloatingDateRangeFilter: true, enableReversedStacking: true, enableSeparateTotalLabels: true, 
        // TNT-1096 Temporary disable for P8.
        enableKPIDashboardExport: false }, _a["msf.enableTenantCustomModel"] = false, _a.drillIntoUrlDocumentationLink = "https://www.gooddata.com/developers/cloud-native/doc/cloud/create-dashboards/drilling-in-dashboards/set-drill-into-hyperlink/", _a), DefaultFeatureFlags);
/**
