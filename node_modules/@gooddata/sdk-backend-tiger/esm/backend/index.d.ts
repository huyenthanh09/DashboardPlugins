import { IAnalyticalBackendConfig, IBackendCapabilities, IAnalyticalBackend, IAnalyticalWorkspace, IAuthenticationProvider, IAuthenticatedPrincipal, IWorkspacesQueryFactory, IUserService, IOrganization, IOrganizations } from "@gooddata/sdk-backend-spi";
import { TelemetryData, IAuthProviderCallGuard } from "@gooddata/sdk-backend-base";
import { DateFormatter } from "../convertors/fromBackend/dateFormatting/types";
import { TigerSpecificFunctions } from "./tigerSpecificFunctions";
/**
 * Client-specific configuration for the tiger backend allows to specify additional telemetry information.
 *
 * @public
 */
export declare type TigerBackendConfig = {
    /**
 ...
 */
declare type TigerSpecificFunctionsSubscription = {
