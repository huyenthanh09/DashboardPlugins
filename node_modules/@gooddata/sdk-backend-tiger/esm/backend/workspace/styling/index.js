...
var TigerWorkspaceStyling = /** @class */ (function () {
    function TigerWorkspaceStyling(authCall, workspace) {
        ...
        this.getColorPalette = function () { return __awaiter(_this, void 0, void 0, function () {
            var userSettings, activeColorPaletteId, enableTheming;
            var _this = this;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        enableTheming = (_c = userSettings.enableTheming) !== null && _c !== void 0 ? _c : false;
                        return [4 /*yield*/, this.isStylizable(activeColorPaletteId, enableTheming)];
        ...
        this.getTheme = function () { return __awaiter(_this, void 0, void 0, function () {
            var userSettings, activeThemeId, enableTheming;
            var _this = this;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        enableTheming = (_c = userSettings.enableTheming) !== null && _c !== void 0 ? _c : false;
                        return [4 /*yield*/, this.isStylizable(activeThemeId, enableTheming)];
                    case 2: return [2 /*return*/, (_d.sent())
                            ? this.authCall(function (client) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, client.entities
     ...
     * @returns boolean
     */
    TigerWorkspaceStyling.prototype.isStylizable = function (activeStyleId, enableTheming) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, isCustomThemingIncludedInEntitlements && enableTheming && activeStyleId !== ""];
                }
            });
        });
    };
