...
var TigerWorkspaceElementsQuery = /** @class */ (function () {
    ...
    TigerWorkspaceElementsQuery.prototype.getExactFilterSpec = function (options) {
        var elements = options.elements, uris = options.uris;
        if (elements) {
            if (uris) {
                                    ...
                                    case 1:
                                        ...
                                        return [2 /*return*/, {
                                                items: elements.map(function (element) {
                                                    ...
                                                    return ({
                                                        title: element.title,
                                                        uri: (_a = element.primaryTitle) !== null && _a !== void 0 ? _a : element.title,
                                                    });
                                                }),
