...
function createNonDateAttributes(attributes) {
    ...
    return nonDateAttributes.map(function (attribute) {
        ...
        var defaultView = (_b = (_a = attribute.relationships) === null || _a === void 0 ? void 0 : _a.defaultView) === null || _b === void 0 ? void 0 : _b.data;
        var defaultViewLabel = defaultView && allLabels.find(function (label) { return label.id === defaultView.id; });
        // use the defaultView if available, fall back to primary: exactly one label is guaranteed to be primary
        var defaultLabel = defaultViewLabel !== null && defaultViewLabel !== void 0 ? defaultViewLabel : allLabels.filter(function (label) { return label.attributes.primary; })[0];
...
export function loadAttributesAndDateDatasets(client, workspaceId, rsqlFilter, loadAttributes, loadDateDatasets) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    includeObjects = ["labels", "defaultView"];
                    if (loadDateDatasets) {
                        includeObjects.push("dataset");
                    }
                    params = addRsqlFilterToParams({ workspaceId: workspaceId, include: includeObjects }, rsqlFilter);
                    return [4 /*yield*/, MetadataUtilities.getAllPagesOf(client, client.entities.getAllEntitiesAttributes, params).then(MetadataUtilities.mergeEntitiesResults)];
                case 1:
                    attributes = _a.sent();
                    catalogItems = [];
                    if (loadAttributes) {
