...
var TigerWorkspaceInsights = /** @class */ (function () {
    function TigerWorkspaceInsights(authCall, workspace) {
        ...
        this.getInsights = function (options) { return __awaiter(_this, void 0, void 0, function () {
            var orderBy, usesOrderingByUpdated, allInsights, sanitizedOrder;
            var _this = this;
            var _a, _b;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authCall(function (client) {
                                return MetadataUtilities.getAllPagesOf(client, client.entities.getAllEntitiesVisualizationObjects, __assign({ workspaceId: _this.workspace }, (usesOrderingByUpdated ? {} : { sort: [orderBy] })), { headers: ValidateRelationsHeader })
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            id = _b.sent();
                            return [4 /*yield*/, this.authCall(function (client) {
                                    return client.entities.getEntityVisualizationObjects({
                                        objectId: id,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        id = _a.sent();
                        return [4 /*yield*/, this.authCall(function (client) {
                                return client.entities.deleteEntityVisualizationObjects({
                                    objectId: id,
                                    workspaceId: _this.workspace,
                                });
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        id = _a.sent();
                        return [4 /*yield*/, this.authCall(function (client) {
                                return MetadataUtilities.getAllPagesOf(client, client.entities.getAllEntitiesAnalyticalDashboards, {
                                    workspaceId: _this.workspace,
