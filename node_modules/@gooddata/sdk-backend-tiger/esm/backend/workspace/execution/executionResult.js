...
var TigerExecutionResult = /** @class */ (function () {
    ...
    TigerExecutionResult.prototype.export = function (options) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var isXlsx, payload;
            var _this = this;
            return __generator(this, function (_c) {
                isXlsx = ((_a = options.format) === null || _a === void 0 ? void 0 : _a.toUpperCase()) === "XLSX";
                payload = {
                ...
                return [2 /*return*/, this.authCall(function (client) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, client.export.createTabularExport({
                                        workspaceId: this.workspace,
                                        tabularExportRequest: payload,
                                    })];
                                case 1:
                                    tabularExport = _b.sent();
    ...
    TigerExecutionResult.prototype.handleExportResultPolling = function (client, payload) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var i, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, client.export.getTabularExport(payload, {
                    ...
                    case 4:
                        i++;
                        return [3 /*break*/, 1];
                    case 5: throw new Error("Export timeout for export id \"" + payload.exportId + "\" in workspace \"" + payload.workspaceId + "\"");
                }
            });
        });
    };
...
var TigerDataView = /** @class */ (function () {
    function TigerDataView(result, execResult, dateFormatter) {
        ...
        var transformDimensionHeaders = getTransformDimensionHeaders(result.dimensions, dateFormatter);
        var transformedResult = transformExecutionResult(execResult, transformDimensionHeaders);
