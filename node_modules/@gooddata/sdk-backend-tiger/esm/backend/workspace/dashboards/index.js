...
import { areObjRefsEqual, isFilterContext, isFilterContextDefinition, isTempFilterContext, } from "@gooddata/sdk-model";
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authCall(function (client) {
                                return MetadataUtilities.getAllPagesOf(client, client.entities.getAllEntitiesAnalyticalDashboards, { workspaceId: _this.workspace })
