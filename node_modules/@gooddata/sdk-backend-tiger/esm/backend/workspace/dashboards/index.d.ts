import { IDashboardReferences, IDashboardWithReferences, IGetDashboardOptions, IWorkspaceDashboardsService, SupportedDashboardReferenceTypes } from "@gooddata/sdk-backend-spi";
import { IFilter, ObjRef, IWidget, IDashboard, IDashboardDefinition, IListedDashboard, IDashboardPlugin, IDashboardPluginDefinition } from "@gooddata/sdk-model";
...
export declare class TigerWorkspaceDashboards implements IWorkspaceDashboardsService {
    ...
    getDashboards: (options?: IGetDashboardOptions | undefined) => Promise<IListedDashboard[]>;
    getDashboard: (ref: ObjRef, filterContextRef?: import("@gooddata/sdk-model").UriRef | import("@gooddata/sdk-model").IdentifierRef | undefined, options?: IGetDashboardOptions | undefined) => Promise<IDashboard>;
    getDashboardWithReferences: (ref: ObjRef, filterContextRef?: import("@gooddata/sdk-model").UriRef | import("@gooddata/sdk-model").IdentifierRef | undefined, options?: IGetDashboardOptions | undefined, types?: SupportedDashboardReferenceTypes[]) => Promise<IDashboardWithReferences>;
    ...
    exportDashboardToPdf: () => Promise<never>;
