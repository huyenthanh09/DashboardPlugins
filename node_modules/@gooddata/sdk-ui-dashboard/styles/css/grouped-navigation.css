...
.grouped-navigation {
  ...
  margin-right: -1px;
  font-size: 16px;
  color: var(--gd-dashboards-navigation-item-color, var(--gd-palette-complementary-8, #94a1ad));
  background-color: var(--gd-dashboards-navigation-backgroundColor, var(--gd-palette-complementary-1, #303442));
...
.grouped-navigation-header {
  display: flex;
  border-bottom: 1px solid var(--gd-dashboards-navigation-borderColor, var(--gd-palette-complementary-4, rgba(148, 161, 173, 0.2)));
  align-items: center;
}
...
.grouped-navigation-groups-divider {
  border-top: 1px solid var(--gd-dashboards-navigation-borderColor, var(--gd-palette-complementary-4, rgba(148, 161, 173, 0.2)));
  margin: 8px 15px;
}
...
.grouped-navigation-section--is-expanded {
  background-color: var(--gd-dashboards-navigation-item-selectedBackgroundColor, var(--gd-palette-complementary-0, #131c28));
}
...
.grouped-navigation-list-item:hover {
  color: var(--gd-dashboards-navigation-item-hoverColor, var(--gd-palette-complementary-9, #fff));
  border-color: var(--gd-palette-complementary-6, rgba(255, 255, 255, 0.5));
}
.grouped-navigation-list-item-selected {
  color: var(--gd-dashboards-navigation-item-selectedColor, var(--gd-palette-complementary-9, #fff));
...
.grouped-mobile-navigation-dropdown .gd-list-item.grouped-mobile-navigation-group {
  ...
  height: 45px;
  line-height: 45px;
  background: var(--gd-palette-complementary-2, rgba(221, 228, 235, 0.2));
}
