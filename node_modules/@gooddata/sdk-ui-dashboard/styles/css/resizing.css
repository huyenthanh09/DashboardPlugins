...
.gd-resize-overlay-text {
  ...
  align-items: center;
  padding: 5px;
  color: var(--gd-palette-complementary-6, #909293);
  font-weight: bold;
  text-align: center;
}
...
.gd-resize-bullet-icon .passive {
  fill: var(--gd-palette-complementary-6, #b0beca);
}
...
.gd-resize-bullets-bar {
  ...
  background: var(--gd-dashboards-content-backgroundColor, var(--gd-palette-complementary-0, rgba(255, 255, 255, 0.95)));
}
