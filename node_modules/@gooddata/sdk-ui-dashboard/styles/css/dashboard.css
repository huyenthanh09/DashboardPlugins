...
.gd-dialog.gd-schedule-email-dialog .gd-schedule-email-dialog-filters-message {
  margin-top: -5px;
  margin-bottom: 20px;
}
...
.gd-attachment-component .gd-attachment-name {
  flex: 1;
  padding-left: 7px;
}
@media only screen and (min-width:641px) {
...
.gd-schedule-email-attachments > .gd-label {
  height: 30px;
  line-height: 30px;
  margin-bottom: 5px;
}
.gd-schedule-email-attachments .gd-attachment-config-button {
  display: inline-block;
  margin: 10px 20px 0 0;
}
.gd-schedule-email-attachments .gd-dashboard-attachment-list {
  flex: 1;
  overflow: hidden;
  margin: -5px 0;
}
...
.gd-schedule-email-attachments .gd-dashboard-attachment-list-content {
  display: flex;
  flex-wrap: wrap;
  overflow: hidden;
  margin: 0 -5px;
}
.gd-schedule-email-attachments .gd-dashboard-attachment {
  display: flex;
  flex-wrap: nowrap;
  overflow: hidden;
  margin: 5px;
}
.gd-schedule-email-attachments .gd-dashboard-attachment-format {
  padding-left: 7px;
  padding-right: 7px;
  display: flex;
  align-items: center;
...
.gd-schedule-email-attachments .gd-dashboard-attachment-name {
  display: flex;
  align-items: center;
  flex-wrap: nowrap;
  overflow: hidden;
...
.gd-schedule-email-attachments .gd-dashboard-attachment-name .shortened-name {
  text-overflow: ellipsis;
  display: inline-block;
  overflow: hidden;
  white-space: nowrap;
...
.gd-schedule-email-attachments .gd-dashboard-attachment-name > span:nth-child(2) {
  margin-left: 7px;
}
...
.gd-scheduled-email-management-dialog .gd-scheduled-email-management-dialog-title {
  margin-bottom: 10px;
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-management-dialog-title > h3 {
  color: var(--gd-modal-title-color, var(--gd-palette-complementary-9, #000));
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-management-dialog-tabs {
  margin-top: 10px;
}
.gd-scheduled-email-management-dialog .gd-scheduled-emails-content {
  flex: 1;
  overflow-x: hidden;
  width: calc(100% + 20px);
  margin: 0 -20px 0 0;
...
.gd-scheduled-email-management-dialog .gd-scheduled-emails-message {
  display: flex;
...
.gd-scheduled-email-management-dialog .gd-loading-equalizer {
  margin: auto;
}
.gd-scheduled-email-management-dialog .gd-scheduled-email {
  display: inline-flex;
...
.gd-scheduled-email-management-dialog .gd-scheduled-email:hover {
  background: var(--gd-palette-complementary-2, #ebeff4);
}
.gd-scheduled-email-management-dialog .gd-scheduled-email:hover .gd-scheduled-email-icon {
  background: transparent;
}
.gd-scheduled-email-management-dialog .gd-scheduled-email:hover .gd-scheduled-email-delete-icon {
  display: block;
}
.gd-scheduled-email-management-dialog .gd-scheduled-email.editable:hover {
  cursor: pointer;
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-icon {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 30px;
...
.gd-scheduled-email-management-dialog .gd-scheduled-email-content {
  display: flex;
  flex: 1;
  overflow: hidden;
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-text-content {
  display: flex;
  flex: 1;
  flex-direction: column;
  justify-content: center;
...
.gd-scheduled-email-management-dialog .gd-scheduled-email-title {
  white-space: nowrap;
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-subtitle {
  white-space: nowrap;
  color: var(--gd-palette-complementary-6, #94a1ad);
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-shortened-text {
  display: block;
  overflow: hidden;
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-delete {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 36px;
...
.gd-scheduled-email-management-dialog .gd-scheduled-email-delete:hover {
  background-color: var(--gd-palette-error-lightest, #fff2f1);
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-delete:hover ~ .gd-scheduled-email-content {
  background-color: var(--gd-palette-error-lightest, #fff2f1);
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-delete:hover .gd-scheduled-email-delete-icon::after {
  color: var(--gd-palette-error-base, #e54d42);
}
.gd-scheduled-email-management-dialog .gd-scheduled-email-delete-icon {
  display: none;
  margin: auto;
}
@media only screen and (max-width: 640px) {
...
.gd-scheduled-email-management-dialog .gd-scheduled-email-delete-icon::after {
  content: "\e61a";
  position: relative;
  font-family: "Indigo", sans-serif;
  color: var(--gd-palette-complementary-5, #b0beca);
...
.gd-scheduled-email-management-dialog .gd-content-divider {
  border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb);
  height: 0;
  margin: 0 0 20px 0;
}
.gd-scheduled-email-management-dialog .gd-buttons {
  display: flex;
  justify-content: space-between;
  flex-wrap: wrap;
  margin: -5px;
}
.gd-scheduled-email-management-dialog .gd-buttons button {
  margin: 5px;
}
.gd-scheduled-email-management-dialog .gd-add-button .gd-button-icon {
...
.gd-scheduled-email-delete-dialog .gd-dialog-content {
  overflow: hidden;
  height: 40px;
  text-overflow: ellipsis;
  line-height: 20px;
...
.gd-scheduled-email-delete-dialog .gd-scheduled-email-delete-dialog-text {
  overflow: hidden;
  line-height: 20px;
  white-space: nowrap;
  text-overflow: ellipsis;
...
@media only screen and (max-width: 640px) {
  .gd-scheduled-email-delete-dialog .gd-scheduled-email-delete-dialog-text > strong {
    display: block;
    overflow: hidden;
    line-height: 20px;
    white-space: nowrap;
...
.gd-scheduled-email-delete-dialog-overlay .modalityPlugin-mask {
  z-index: 5001;
}
@media only screen and (max-width: 640px) {
  .gd-scheduled-email-delete-dialog-overlay .modalityPlugin-mask {
...
.gd-schedule-email-dialog-attachments > div {
  margin: 5px 10px;
}

.gd-schedule-dropdown-button {
  display: flex;
  align-items: center;
  height: 30px;
  margin: 0;
...
.gd-schedule-dropdown-button-icon {
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
...
.gd-schedule-dropdown-button-disabled {
  color: var(--gd-palette-complementary-5, #b0beca);
}
.gd-schedule-dropdown-button-disabled svg {
  fill: var(--gd-palette-complementary-5, #b0beca);
}
.gd-schedule-dropdown-button-disabled:hover {
  color: var(--gd-palette-complementary-5, #b0beca);
}
.gd-schedule-dropdown-body {
  display: flex;
  flex-direction: column;
  height: inherit;
  font-size: 12px;
...
.gd-format-options-dropdown-selector {
  display: flex;
  flex-direction: row;
  align-items: center;
  height: 28px;
}
.gd-format-options-dropdown-selector > div {
  margin-left: 15px;
}
...
.gd-format-options-dropdown-xlsx {
  display: flex;
  flex-direction: column;
  border-left: 1px dashed var(--gd-palette-complementary-7, #6d7680);
  padding-left: 10px;
  margin-top: 5px;
  font-size: 14px;
  color: var(--gd-palette-complementary-8, #464e56);
}
.gd-format-options-dropdown-xlsx > div:not(:first-child) {
  margin-top: 10px;
}
.gd-format-options-dropdown-xlsx > div {
  display: flex;
  align-items: center;
  height: 28px;
}
.gd-format-options-dropdown-xlsx > div > label {
  display: flex;
  align-items: center;
  width: 100%;
  padding-right: 0;
}
.gd-format-options-dropdown-xlsx > div > label > span {
  margin-left: 4px;
  white-space: nowrap;
}
...
.gd-attachments-selection-dropdown h3 {
  flex-grow: 2;
  position: relative;
  overflow: hidden;
  height: 23px;
...
.gd-attachments-selection-dropdown h3::after {
  content: "";
  position: absolute;
  top: 50%;
  display: inline-block;
  ...
  height: 0;
  margin-left: 10px;
  border-top: 1px solid var(--gd-palette-complementary-6, #94a1ad);
}
.gd-attachments-selection-dropdown > div:not(:last-child) {
  margin-bottom: 10px;
}
.gd-attachments-selection-dropdown > div {
  display: flex;
  align-items: center;
  overflow: hidden;
  height: 28px;
}
.gd-attachments-selection-dropdown > div > label {
  display: flex;
  align-items: center;
  overflow: hidden;
  width: 100%;
...
.gd-attachments-selection-dropdown > div > label > svg {
  margin-left: 4px;
  margin-right: 6px;
  flex-shrink: 0;
}
.gd-attachments-selection-dropdown > div > label > span {
  overflow: hidden;
  white-space: nowrap;
  text-overflow: ellipsis;
  margin-left: 4px;
...
.gd-dashboards-root button,
.gd-dashboards-root input,
.gd-dashboards-root optgroup,
.gd-dashboards-root select,
...
.dash-item.is-selected .dash-item-action-lw-options {
  display: block;
  background-color: var(--gd-palette-complementary-7, #b4c0cf);
}
...
.dash-item-action-placeholder-headline {
  right: calc(
        -10px - var(--gd-dashboards-content-widget-borderWidth, 2px) + 36px + 5px
    );
}
...
.dash-item-action-lw-options {
  ...
  display: none;
  border-radius: 50%;
  background-color: var(--gd-palette-complementary-2, #eceff3);
  width: 36px;
  height: 36px;
  transition: 0.2s;
}
.dash-item-action-lw-options::before {
  ...
  top: -5px;
  display: inline;
  color: var(--gd-palette-complementary-7, #b4c0cf);
}
