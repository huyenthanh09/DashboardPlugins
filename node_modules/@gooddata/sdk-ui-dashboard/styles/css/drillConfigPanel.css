...
.gd-drill-config-measure-item {
  ...
  margin: 6px 0;
  border: 1px solid var(--gd-palette-complementary-4, #ccd8e2);
  box-shadow: 0 1px 1px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.15));
  line-height: 25px;
...
.gd-dialog.gd-drill-custom-url-editor .gd-input-syntax-highlighting-input .CodeMirror {
  width: 340px;
  height: 270px;
}
.gd-dialog.gd-drill-custom-url-editor .gd-drill-to-url-parameters {
  ...
  width: 200px;
  height: 270px;
  border: 1px solid var(--gd-palette-complementary-3, #c9d5e0);
...
.gd-dialog.gd-drill-custom-url-editor .CodeMirror-code .CodeMirror-matchingbracket {
  color: inherit;
  background-color: #fff;
}
.gd-dialog.gd-drill-custom-url-editor .CodeMirror-code .CodeMirror-nonmatchingbracket {
  color: inherit;
}
.gd-dialog.gd-drill-custom-url-editor .CodeMirror-code .cm-identifier {
  color: var(--gd-palette-primary-base, #14b2e2);
}
.gd-dialog.gd-drill-custom-url-editor .CodeMirror-code .cm-attribute {
  color: #f18600;
}
.gd-dialog.gd-drill-custom-url-editor .CodeMirror-code .cm-invalid-identifier,
.gd-dialog.gd-drill-custom-url-editor .CodeMirror-code .cm-invalid-attribute {
...
/*# sourceMappingURL=drillConfigPanel.css.map */
