...
export declare function useOriginalConfigurationState(neighborFilters: IDashboardAttributeFilter[], filterElementsBy: IDashboardAttributeFilterParent[] | undefined): {
    ...
    selectedConnectingAttribute: import("@gooddata/sdk-model").UriRef | import("@gooddata/sdk-model").IdentifierRef | undefined;
}[];
//# sourceMappingURL=useOriginalConfigurationState.d.ts.map