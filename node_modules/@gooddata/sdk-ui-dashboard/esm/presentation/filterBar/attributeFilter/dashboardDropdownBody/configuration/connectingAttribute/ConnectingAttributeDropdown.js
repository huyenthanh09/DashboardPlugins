...
export var ConnectingAttributeDropdown = function (props) {
    ...
    var selectedConnectingAttribute = connectingAttributes.find(function (attr) {
        return areObjRefsEqual(attr.ref, selectedConnectingAttributeRef);
    });
    ...
    return (React.createElement(Dropdown, { className: "connecting-attributes-dropdown s-connecting-attributes-dropdown", closeOnParentScroll: true, closeOnMouseDrag: true, closeOnOutsideClick: true, alignPoints: ALIGN_POINTS, renderButton: function (_a) {
            ...
            return (React.createElement(DropdownButton, { value: selectedConnectingAttribute.title, iconLeft: "gd-icon-attribute", title: selectedConnectingAttribute.title, isOpen: isOpen, onClick: toggleDropdown }));
