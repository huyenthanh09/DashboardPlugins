...
export var useDashboard = function (props) {
    ...
    var dateFilterProvider = useCallback(function (filter) {
        var userSpecified = DashboardDateFilterComponentProvider === null || DashboardDateFilterComponentProvider === void 0 ? void 0 : DashboardDateFilterComponentProvider(filter);
    ...
    var insightWidgetComponentSet = useMemo(function () {
        var defaultComponentSet = DefaultDashboardInsightComponentSetFactory(insightProvider);
    ...
    var kpiWidgetComponentSet = useMemo(function () {
        return DefaultDashboardKpiComponentSetFactory(kpiProvider);
    }, [kpiProvider]);
    var attributeFilterComponentSet = useMemo(function () {
    ...
    return {
        ...
        dateFilterProvider: dateFilterProvider,
