...
export var DashboardLayoutSectionBorderMarker = function (props) {
    var active = props.active, className = props.className;
    var background = active ? "var(--gd-palette-primary-base, " + GD_COLOR_HIGHLIGHT + ")" : "#E6E6E6";
    var color = active ? GD_COLOR_WHITE : INFO_TEXT_COLOR;
