...
import { insightTitle, insightVisualizationUrl, insightUpdated, insightIsLocked, isUriRef, areObjRefsEqual, } from "@gooddata/sdk-model";
...
import { selectCurrentUserRef, selectInsightListLastUpdateRequested, useDashboardSelector, } from "../../model";
...
export var InsightList = function (_a) {
    var height = _a.height, searchAutofocus = _a.searchAutofocus, noDataButton = _a.noDataButton, renderItem = _a.renderItem, selectedRef = _a.selectedRef, onSelect = _a.onSelect;
    var intl = useIntl();
    ...
    var insightListLastUpdateRequested = useDashboardSelector(selectInsightListLastUpdateRequested);
    ...
    }, params, [backend, pagesToLoad, search, selectedTabId, insightListLastUpdateRequested], [search, selectedTabId, pagesToLoad.length === 0, insightListLastUpdateRequested]), insights = _f.items, totalInsightsCount = _f.totalItemsCount, isLoading = _f.isLoading;
    useEffect(function () {
    ...
    return (React.createElement(DropdownList, { width: LIST_WIDTH, height: height && height - controlsHeight, isMobile: false, isLoading: isLoading && insights.length === 0, showSearch: initialLoadCompleted, searchString: search, searchFieldSize: "small", searchPlaceholder: intl.formatMessage({ id: "search_insights" }), onSearch: onSearch, disableAutofocus: !searchAutofocus, showTabs: initialLoadCompleted && !search, tabs: backend.capabilities.supportsOwners && userUri ? dropdownTabsTranslationIds : undefined, selectedTabId: selectedTabId, onTabSelect: function (_a) {
            ...
            var isSelected = areObjRefsEqual(insight.insight.ref, selectedRef);
            return (React.createElement(InsightListItem, { title: title, type: insightListSourceItem.insightType, width: width, isSelected: isSelected, updated: insightUpdated(insightListSourceItem.insight), isLocked: insightIsLocked(insightListSourceItem.insight), onClick: function () { return onSelect === null || onSelect === void 0 ? void 0 : onSelect(insight); } }));
