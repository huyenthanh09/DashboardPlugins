...
import { getDashboardLayoutWidgetMaxGridHeight, getDashboardLayoutWidgetMinGridHeight, getDashboardLayoutWidgetMinGridWidth, getSizeInfo, } from "../../../../_staging/layout/sizing";
...
export function unifyDashboardLayoutItemHeights(itemsOrLayout) {
    if (isDashboardLayout(itemsOrLayout)) {
        var updatedLayout = __assign(__assign({}, itemsOrLayout), { sections: DashboardLayoutFacade.for(itemsOrLayout)
                ...
                acc.push(__assign(__assign({}, section.raw()), { items: unifyDashboardLayoutItemHeights(section.items().raw()) }));
                return acc;
            }, []) });
