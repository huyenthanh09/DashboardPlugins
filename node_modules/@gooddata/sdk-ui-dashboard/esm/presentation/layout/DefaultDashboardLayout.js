...
import { useDashboardSelector, selectIsExport, selectIsLayoutEmpty, selectLayout, selectInsightsMap, selectEnableWidgetCustomHeight, selectRenderMode, } from "../../model";
...
export var DefaultDashboardLayout = function (props) {
    var onFiltersChange = props.onFiltersChange, onDrill = props.onDrill, onError = props.onError;
    ...
    var renderMode = useDashboardSelector(selectRenderMode);
    ...
    var shouldRenderSectionHotspot = transformedLayout.sections.length > 1 ||
        transformedLayout.sections[0].items.some(function (i) { return !isInitialPlaceholderWidget(i.widget); });
