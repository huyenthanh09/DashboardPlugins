...
var tooltipAlignPoints = [{ align: "cl cr" }];
export var DashboardInsightMenuItemButton = function (props) {
    var itemId = props.itemId, itemName = props.itemName, disabled = props.disabled, icon = props.icon, onClick = props.onClick, tooltip = props.tooltip, className = props.className, _a = props.submenu, submenu = _a === void 0 ? false : _a;
