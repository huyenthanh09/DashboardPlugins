...
import { selectDashboardRef, selectDisableKpiDashboardHeadlineUnderline, selectFilterContextFilters, selectIsReadOnly, selectSeparators, useDashboardSelector, } from "../../../../model";
...
export var DashboardKpiCore = function (props) {
    var kpiWidget = props.kpiWidget, alert = props.alert, onFiltersChange = props.onFiltersChange, onDrill = props.onDrill, onError = props.onError, customBackend = props.backend, customWorkspace = props.workspace, CustomErrorComponent = props.ErrorComponent, CustomLoadingComponent = props.LoadingComponent;
    ...
    var kpiData = useKpiData({ kpiWidget: kpiWidget, dashboardFilters: dashboardFilters });
