...
export declare class KpiAlertDialog extends Component<IKpiAlertDialogProps & WrappedComponentProps, IKpiAlertDialogState> {
    ...
    getVisualThreshold(props?: Readonly<IKpiAlertDialogProps & WrappedComponentProps<"intl">> & Readonly<{
    ...
    isThresholdRepresentingPercent(props?: Readonly<IKpiAlertDialogProps & WrappedComponentProps<"intl">> & Readonly<{
        children?: React.ReactNode;
    }>): boolean;
...
declare const _default: React.FC<import("react-intl").WithIntlProps<IKpiAlertDialogProps & WrappedComponentProps<"intl">>> & {
    WrappedComponent: React.ComponentType<IKpiAlertDialogProps & WrappedComponentProps<"intl">>;
};
export default _default;
//# sourceMappingURL=KpiAlertDialog.d.ts.map