...
export function useKpiExecutionDataView(config) {
    var primaryMeasure = config.primaryMeasure, backend = config.backend, effectiveFilters = config.effectiveFilters, secondaryMeasure = config.secondaryMeasure, workspace = config.workspace, shouldLoad = config.shouldLoad;
    var response = useExecutionDataView({
        backend: backend,
        workspace: workspace,
