...
var KpiValue = /** @class */ (function (_super) {
    ...
    KpiValue.prototype.renderValue = function () {
        var _a = this.props, isLoading = _a.isLoading, error = _a.error, disableKpiDrillUnderline = _a.disableKpiDrillUnderline, enableCompactSize = _a.enableCompactSize, clientHeight = _a.clientHeight, intl = _a.intl;
        if (isLoading) {
            return React.createElement(LoadingDots, { className: "kpi-value-loading gd-loading-dots-centered" });
        }
        var value = error ? intl.formatMessage({ id: "error" }) : this.renderFormattedValue();
