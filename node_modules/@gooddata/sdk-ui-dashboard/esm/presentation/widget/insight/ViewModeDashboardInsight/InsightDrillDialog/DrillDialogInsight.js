...
export var DrillDialogInsight = function (props) {
    var insight = props.insight, widget = props.widget, backend = props.backend, workspace = props.workspace, onError = props.onError, onDrillFn = props.onDrill, onExportReady = props.onExportReady, onLoadingChanged = props.onLoadingChanged, pushData = props.pushData, ErrorComponent = props.ErrorComponent, LoadingComponent = props.LoadingComponent;
    // Context
    var effectiveBackend = useBackendStrict(backend);
    var effectiveWorkspace = useWorkspaceStrict(workspace);
    // State props
    var _a = useDashboardSelector(selectCommonDashboardInsightProps), locale = _a.locale, settings = _a.settings, colorPalette = _a.colorPalette;
    var chartConfig = useDashboardSelector(selectChartConfig);
    // Loading and rendering
    var _b = __read(useState(false), 2), isVisualizationLoading = _b[0], setIsVisualizationLoading = _b[1];
    var _c = __read(useState(), 2), visualizationError = _c[0], setVisualizationError = _c[1];
    ...
    // Filtering
    var _d = useWidgetFilters(widget, insight), filtersForInsight = _d.result, filtersStatus = _d.status, filtersError = _d.error;
    ...
    var _e = useDrillDialogInsightDrills({
        widget: widget,
        insight: insightWithAddedFilters !== null && insightWithAddedFilters !== void 0 ? insightWithAddedFilters : insight,
        onDrill: onDrillFn,
    }), drillableItems = _e.drillableItems, onDrill = _e.onDrill, onPushData = _e.onPushData;
