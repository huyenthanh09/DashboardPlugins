...
import { selectColorPalette, selectDrillableItems, selectIsExport, selectLocale, selectMapboxToken, selectSeparators, selectSettings, useDashboardAsyncRender, useDashboardSelector, useWidgetExecutionsHandler, } from "../../../../../model";
...
export var DashboardInsight = function (props) {
    ...
    // Custom components
    var _b = useDashboardComponentsContext({
        ErrorComponent: CustomErrorComponent,
        LoadingComponent: CustomLoadingComponent,
    }), ErrorComponent = _b.ErrorComponent, LoadingComponent = _b.LoadingComponent;
    // Context
    ...
    // State props
    var _c = useDashboardSelector(selectCommonDashboardInsightProps), locale = _c.locale, settings = _c.settings, colorPalette = _c.colorPalette;
    ...
    var _d = __read(useState(false), 2), isVisualizationLoading = _d[0], setIsVisualizationLoading = _d[1];
    var _e = __read(useState(), 2), visualizationError = _e[0], setVisualizationError = _e[1];
    var _f = useDashboardAsyncRender(objRefToString(widgetRef(widget))), onRequestAsyncRender = _f.onRequestAsyncRender, onResolveAsyncRender = _f.onResolveAsyncRender;
    ...
    // Filtering
    var _g = useWidgetFilters(widget), filtersForInsight = _g.result, filtersStatus = _g.status, filtersError = _g.error;
    ...
    var _h = useDashboardInsightDrills({
        widget: widget,
        insight: insight,
        onDrill: onDrillFn,
    }), drillableItems = _h.drillableItems, onDrill = _h.onDrill, onPushData = _h.onPushData;
    ...
    var effectiveError = filtersError !== null && filtersError !== void 0 ? filtersError : visualizationError;
    // CSS
    ...
    var visualizationProperties = insightProperties(insightWithAddedWidgetProperties);
    var isZoomable = (_a = visualizationProperties === null || visualizationProperties === void 0 ? void 0 : visualizationProperties.controls) === null || _a === void 0 ? void 0 : _a.zoomInsight;
    return (React.createElement("div", { className: "visualization-content" },
        React.createElement("div", { className: cx("gd-visualization-content", { zoomable: isZoomable }), style: insightPositionStyle },
            React.createElement(IntlWrapper, { locale: locale },
                ...
                effectiveError && (React.createElement(CustomError, { error: effectiveError, isCustomWidgetHeightEnabled: !!(settings === null || settings === void 0 ? void 0 : settings.enableKDWidgetCustomHeight), height: clientHeight, width: clientWidth })),
