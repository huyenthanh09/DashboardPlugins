...
import { selectAccessibleDashboards, selectDashboardTitle, selectInsightsMap, useDashboardSelector, } from "../../../model";
...
export var DrillSelectDropdown = function (props) {
    ...
    var intl = useIntl();
    var listedDashboards = useDashboardSelector(selectAccessibleDashboards);
    ...
    return drillDefinitions.map(function (drillDefinition) {
        ...
        if (isDrillDownDefinition(drillDefinition)) {
            ...
            return {
                ...
                name: title !== null && title !== void 0 ? title : "NULL",
