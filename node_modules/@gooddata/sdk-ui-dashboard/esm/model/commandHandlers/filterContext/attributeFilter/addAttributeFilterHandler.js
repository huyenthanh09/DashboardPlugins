...
export function addAttributeFilterHandler(ctx, cmd) {
    var _a, displayForm, index, initialIsNegativeSelection, initialSelection, parentFilters, allFilters, resolvedDisplayForm, canBeAdded, displayFormMetadata, addedFilter;
