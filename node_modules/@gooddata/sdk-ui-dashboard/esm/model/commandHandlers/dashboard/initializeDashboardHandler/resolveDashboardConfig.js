...
export function resolveDashboardConfig(ctx, cmd) {
    var _a, config, _b, dateFilterConfig, settings, colorPalette, _c, validDateFilterConfig, configValidation, configWithDefaults;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 4:
                ...
                return [2 /*return*/, __assign(__assign({}, configWithDefaults), { locale: settings.locale, separators: settings.separators, dateFilterConfig: validDateFilterConfig, settings: configWithDefaults.allowUnfinishedFeatures
                            ? settings.settings
