...
function loadExistingDashboard(ctx, cmd, dashboardRef) {
    var backend, privateCtx, _a, dashboardWithReferences, config, permissions, catalog, alerts, user, listedDashboards, accessibleDashboards, legacyDashboards, dashboard, insights, effectiveDateFilterConfig, initActions, batch, event;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _a = __read.apply(void 0, [_b.sent(), 9]), dashboardWithReferences = _a[0], config = _a[1], permissions = _a[2], catalog = _a[3], alerts = _a[4], user = _a[5], listedDashboards = _a[6], accessibleDashboards = _a[7], legacyDashboards = _a[8];
...
function initializeNewDashboard(ctx, cmd) {
    var backend, _a, config, permissions, catalog, user, listedDashboards, accessibleDashboards, legacyDashboards, batch, event;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                backend = ctx.backend;
            ...
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 7]), config = _a[0], permissions = _a[1], catalog = _a[2], user = _a[3], listedDashboards = _a[4], accessibleDashboards = _a[5], legacyDashboards = _a[6];
                batch = batchActions(__spread([
                    backendCapabilitiesActions.setBackendCapabilities(backend.capabilities),
                    configActions.setConfig(config),
                    userActions.setUser(user),
