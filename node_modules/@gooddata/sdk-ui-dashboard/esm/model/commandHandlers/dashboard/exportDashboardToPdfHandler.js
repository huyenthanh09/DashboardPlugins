...
export function exportDashboardToPdfHandler(ctx, cmd) {
    var dashboardRef, filterContextFilters, effectiveFilters, resultUri, fullUri;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                resultUri = _a.sent();
                fullUri = ctx.backend.config.hostname
                    ? new URL(resultUri, ctx.backend.config.hostname).href
                    : resultUri;
                return [2 /*return*/, dashboardExportToPdfResolved(ctx, fullUri, cmd.correlationId)];
        }
    });
}
