...
import { isLocalIdRef, isIdentifierRef, isUriRef, areObjRefsEqual, localIdRef, isDrillFromAttribute, isDrillFromMeasure, } from "@gooddata/sdk-model";
...
import { selectAllCatalogDisplayFormsMap, selectAttributesWithDisplayFormLink, selectAttributesWithDrillDown, } from "../catalog/catalogSelectors";
...
export var selectValidConfiguredDrillsByWidgetRef = createMemoizedSelector(function (ref) {
    return createSelector(selectConfiguredDrillsByWidgetRef(ref), selectAllCatalogDisplayFormsMap, selectAccessibleDashboardsMap, selectInsightsMap, function (drills, displayFormsMap, accessibleDashboardsMap, insightsMap) {
        if (drills === void 0) { drills = []; }
        return drills.filter(function (drill) {
...
export var selectDrillableItemsByAvailableDrillTargets = createMemoizedSelector(function (availableDrillTargets) {
    return createSelector(selectImplicitDrillsByAvailableDrillTargets(availableDrillTargets), function (implicitDrillDowns) {
        return flatMap(implicitDrillDowns, function (implicitDrill) { return implicitDrill.predicates; });
    });
});
