...
var selectSelf = createSelector(function (state) { return state; }, function (state) { return state.user; });
/**
 ...
 * @public
 */
export var selectCurrentUserRef = createSelector(selectCurrentUser, function (user) {
    return user.ref;
});
