 ...
 * @alpha
 */
export var selectEffectiveDateFilterMode = createSelector(selectIsInEditMode, selectDateFilterConfigOverrides, function (isInEditMode, dashboardOverrides) {
    var _a;
    if (isInEditMode) {
        return "active";
    }
 ...
 * @alpha
 */
export var selectDateFilterConfigValidationWarnings = createSelector(selectSelf, function (dateFilterConfigState) {
    var _a;
