 ...
 * @public
 */
export declare const selectDateFilterConfig: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").IDateFilterConfig, (res: import("../..").ResolvedDashboardConfig) => import("@gooddata/sdk-model").IDateFilterConfig>;
/**
 * Returns settings that are in effect for the current dashboard.
 *
 * @public
 */
export declare const selectSettings: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").ISettings, (res: import("../..").ResolvedDashboardConfig) => import("@gooddata/sdk-model").ISettings>;
/**
 ...
 * @public
 */
export declare const selectSeparators: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").ISeparators, (res: import("../..").ResolvedDashboardConfig) => import("@gooddata/sdk-model").ISeparators>;
/**
 ...
 * @internal
 */
export declare const selectIsWhiteLabeled: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 ...
 * @internal
 */
export declare const selectIsSaveAsNewButtonHidden: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns date format.
 *
 * @public
 ...
 * @public
 */
export declare const selectEnableKPIDashboardSchedule: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether the current user can share scheduled email to other recipients.
 *
 * @public
 */
export declare const selectEnableKPIDashboardScheduleRecipients: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns current platform edition.
 *
 * @public
 */
export declare const selectPlatformEdition: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").PlatformEdition, (res: import("../..").ResolvedDashboardConfig) => import("@gooddata/sdk-model").PlatformEdition>;
/**
 ...
 * @public
 */
export declare const selectEnableInsightExportScheduling: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether dashboard edit mode is enabled.
 *
 * @internal
 */
export declare const selectDashboardEditModeDevRollout: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether analytical dashboard permissions are enabled
 *
 * @internal
 */
export declare const selectEnableAnalyticalDashboardPermissions: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether custom widget heights are enabled
 *
 * @internal
 */
export declare const selectEnableWidgetCustomHeight: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether we should call workspaces workspaces (true) or projects (false).
 *
 * @internal
 */
export declare const selectEnableRenamingProjectToWorkspace: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether we should call measures metrics (true) or measures (false).
 *
 * @internal
 */
export declare const selectEnableRenamingMeasureToMetric: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether we should hide the pixel perfect experience references.
 *
 * @internal
 */
export declare const selectShouldHidePixelPerfectExperience: import("@reduxjs/toolkit").OutputSelector<DashboardState, string | number | boolean | object, (res: import("../..").ResolvedDashboardConfig) => string | number | boolean | object>;
/**
 * Returns whether we should disable the underline in KPIs when they are drillable.
 *
 * @internal
 */
export declare const selectDisableKpiDashboardHeadlineUnderline: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether unfinished features are allowed.
 *
 * @internal
 */
export declare const selectAllowUnfinishedFeatures: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether analytical designer is enabled.
 *
 * @internal
 */
export declare const selectIsAnalyticalDesignerEnabled: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
/**
 * Returns whether delete button in dashboard attribute filters is visible.
 *
 * @internal
 */
export declare const selectIsDeleteFilterButtonEnabled: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res: import("../..").ResolvedDashboardConfig) => boolean>;
