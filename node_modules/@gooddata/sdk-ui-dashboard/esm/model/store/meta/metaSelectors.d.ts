 ...
 * @public
 */
export declare const selectDashboardTags: import("@reduxjs/toolkit").OutputSelector<DashboardState, string[], (res: import("./metaState").DashboardDescriptor) => string[]>;
/**
 ...
 * @internal
 */
export declare const selectIsLayoutChanged: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res1: import("@gooddata/sdk-model").IDashboardLayout<import("@gooddata/sdk-model").IDashboardWidget> | undefined, res2: import("@gooddata/sdk-model").IDashboardLayout<import("@gooddata/sdk-model").IWidget>) => boolean>;
/**
 * Selects a boolean indication if he dashboard has any changes compared to the persisted version (if any)
 *
 * @internal
 */
export declare const selectIsDashboardDirty: import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res1: boolean, res2: import("@gooddata/sdk-model").IDashboardLayout<import("@gooddata/sdk-model").IWidget>, res3: boolean, res4: boolean, res5: boolean) => boolean>;
