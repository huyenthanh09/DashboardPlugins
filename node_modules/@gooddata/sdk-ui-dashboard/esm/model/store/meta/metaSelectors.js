 ...
 * @internal
 */
export var selectIsLayoutChanged = createSelector(selectPersistedDashboardLayout, selectBasicLayout, function (persistedLayout, currentLayout) {
 ...
 * @internal
 */
export var selectIsDashboardDirty = createSelector(selectIsNewDashboard, selectBasicLayout, selectIsFiltersChanged, selectIsTitleChanged, selectIsLayoutChanged, function (isNew, layout, isFiltersChanged, isTitleChanged, isLayoutChanged) {
    if (isNew) {
