import { ObjRef, IWidget, IDashboardLayout } from "@gooddata/sdk-model";
 ...
 * @internal
 */
export declare const selectWidgets: import("@reduxjs/toolkit").OutputSelector<DashboardState, ExtendedDashboardWidget[], (res: IDashboardLayout<ExtendedDashboardWidget>) => ExtendedDashboardWidget[]>;
/**
 ...
 * @internal
 */
export declare const selectWidgetsMap: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("../../../_staging/metadata/objRefMap").ObjRefMap<ExtendedDashboardWidget>, (res: ExtendedDashboardWidget[]) => import("../../../_staging/metadata/objRefMap").ObjRefMap<ExtendedDashboardWidget>>;
/**
 ...
 * @alpha
 */
export declare const selectWidgetByRef: (ref: ObjRef | undefined) => import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").IKpiWidget | import("@gooddata/sdk-model").IInsightWidget | import("../../types/layoutTypes").ICustomWidget | undefined, (res: import("../../../_staging/metadata/objRefMap").ObjRefMap<ExtendedDashboardWidget>) => import("@gooddata/sdk-model").IKpiWidget | import("@gooddata/sdk-model").IInsightWidget | import("../../types/layoutTypes").ICustomWidget | undefined>;
/**
 ...
 * @alpha
 */
export declare const selectAnalyticalWidgetByRef: (ref: ObjRef | undefined) => import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").IKpiWidget | import("@gooddata/sdk-model").IInsightWidget | undefined, (res: import("../../../_staging/metadata/objRefMap").ObjRefMap<ExtendedDashboardWidget>) => import("@gooddata/sdk-model").IKpiWidget | import("@gooddata/sdk-model").IInsightWidget | undefined>;
/**
 * Selects widget drills by the widget ref.
 *
 * @alpha
 */
export declare const selectWidgetDrills: (ref: ObjRef | undefined) => import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").IDrillToLegacyDashboard[] | import("@gooddata/sdk-model").InsightDrillDefinition[], (res: import("@gooddata/sdk-model").IKpiWidget | import("@gooddata/sdk-model").IInsightWidget | undefined) => import("@gooddata/sdk-model").IDrillToLegacyDashboard[] | import("@gooddata/sdk-model").InsightDrillDefinition[]>;
/**
...
})[], (res1: import("@gooddata/sdk-model").IKpiWidget | import("@gooddata/sdk-model").IInsightWidget | import("../../types/layoutTypes").ICustomWidget | undefined, res2: import("@gooddata/sdk-model").FilterContextItem[]) => (import("@gooddata/sdk-model").IPositiveAttributeFilter | import("@gooddata/sdk-model").INegativeAttributeFilter | import("@gooddata/sdk-model").IAbsoluteDateFilter | {
    relativeDateFilter: {
        dataSet: ObjRef;
        granularity: import("@gooddata/sdk-model").DateAttributeGranularity;
        from: number;
 ...
 * @alpha
 */
export declare const selectAllKpiWidgets: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").IKpiWidget[], (res: ExtendedDashboardWidget[]) => import("@gooddata/sdk-model").IKpiWidget[]>;
/**
 * Selects all insight widgets in the layout.
 *
 * @alpha
 */
export declare const selectAllInsightWidgets: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").IInsightWidget[], (res: ExtendedDashboardWidget[]) => import("@gooddata/sdk-model").IInsightWidget[]>;
/**
 ...
 * @alpha
 */
export declare const selectWidgetCoordinatesByRef: (ref: ObjRef) => import("@reduxjs/toolkit").OutputSelector<DashboardState, ILayoutCoordinates, (res: IDashboardLayout<ExtendedDashboardWidget>) => ILayoutCoordinates>;
/**
 * @internal
 */
export declare const selectWidgetPlaceholder: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("../../../widgets").PlaceholderWidget | undefined, (res: import("../../types/layoutTypes").ICustomWidget[]) => import("../../../widgets").PlaceholderWidget | undefined>;
/**
 * @internal
 */
export declare const selectWidgetPlaceholderCoordinates: import("@reduxjs/toolkit").OutputSelector<DashboardState, {
    sectionIndex: number;
    itemIndex: number;
} | undefined, (res1: import("../../../widgets").PlaceholderWidget | undefined, res2: IDashboardLayout<ExtendedDashboardWidget>) => {
    sectionIndex: number;
    itemIndex: number;
} | undefined>;
/**
 * @internal
 */
export declare const selectInsightWidgetPlaceholder: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("../../../widgets").InsightPlaceholderWidget | undefined, (res: import("../../types/layoutTypes").ICustomWidget[]) => import("../../../widgets").InsightPlaceholderWidget | undefined>;
/**
 * @internal
 */
export declare const selectInsightWidgetPlaceholderCoordinates: import("@reduxjs/toolkit").OutputSelector<DashboardState, {
    sectionIndex: number;
    itemIndex: number;
} | undefined, (res1: import("../../../widgets").InsightPlaceholderWidget | undefined, res2: IDashboardLayout<ExtendedDashboardWidget>) => {
    sectionIndex: number;
    itemIndex: number;
} | undefined>;
/**
 * @internal
 */
export declare const selectKpiWidgetPlaceholder: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("../../../widgets").KpiPlaceholderWidget | undefined, (res: import("../../types/layoutTypes").ICustomWidget[]) => import("../../../widgets").KpiPlaceholderWidget | undefined>;
/**
 * @internal
 */
export declare const selectKpiWidgetPlaceholderCoordinates: import("@reduxjs/toolkit").OutputSelector<DashboardState, {
    sectionIndex: number;
    itemIndex: number;
} | undefined, (res1: import("../../../widgets").KpiPlaceholderWidget | undefined, res2: IDashboardLayout<ExtendedDashboardWidget>) => {
    sectionIndex: number;
    itemIndex: number;
} | undefined>;
