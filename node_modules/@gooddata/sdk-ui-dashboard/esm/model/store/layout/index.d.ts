...
export declare const layoutActions: import("@reduxjs/toolkit").CaseReducerActions<{
    setLayout: import("@reduxjs/toolkit").CaseReducer<import("./layoutState").LayoutState, {
        payload: import("@gooddata/sdk-model").IDashboardLayout<import("../..").ExtendedDashboardWidget>;
        type: string;
    }>;
    ...
    replaceKpiWidgetDrill: import("@reduxjs/toolkit").CaseReducer<import("./layoutState").LayoutState, {
        payload: import("../_infra/undoEnhancer").UndoPayload<import("../..").IDashboardCommand> & {
            ref: import("@gooddata/sdk-model").ObjRef;
    ...
    changeItemsHeight: import("@reduxjs/toolkit").CaseReducer<import("./layoutState").LayoutState, {
        payload: {
            sectionIndex: number;
            itemIndexes: number[];
            height: number;
    ...
    changeItemWidth: import("@reduxjs/toolkit").CaseReducer<import("./layoutState").LayoutState, {
        payload: {
            sectionIndex: number;
            itemIndex: number;
            width: number;
