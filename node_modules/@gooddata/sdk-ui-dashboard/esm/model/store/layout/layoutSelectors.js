...
import { objRefToString, isKpiWidget, isInsightWidget, areObjRefsEqual, } from "@gooddata/sdk-model";
 ...
 * @internal
 */
export var selectWidgets = createSelector(selectLayout, function (layout) {
    var e_1, _a, e_2, _b;
    var items = [];
    try {
 ...
 * @internal
 */
export var selectWidgetsMap = createSelector(selectWidgets, function (widgets) {
...
function getWidgetCoordinates(layout, ref) {
    var _a;
    for (var sectionIndex = 0; sectionIndex < layout.sections.length; sectionIndex++) {
 ...
 * @alpha
 */
export var selectWidgetCoordinatesByRef = createMemoizedSelector(function (ref) {
    return createSelector(selectLayout, function (layout) {
        var coords = getWidgetCoordinates(layout, ref);
 ...
 * @internal
 */
export var selectWidgetPlaceholder = createSelector(selectAllCustomWidgets, function (customWidgets) {
    return customWidgets.find(isPlaceholderWidget);
});
/**
 * @internal
 */
export var selectWidgetPlaceholderCoordinates = createSelector(selectWidgetPlaceholder, selectLayout, function (widgetPlaceholder, layout) {
    return widgetPlaceholder ? getWidgetCoordinates(layout, widgetPlaceholder.ref) : undefined;
});
/**
 * @internal
 */
export var selectInsightWidgetPlaceholder = createSelector(selectAllCustomWidgets, function (customWidgets) {
    return customWidgets.find(isInsightPlaceholderWidget);
});
/**
 * @internal
 */
export var selectInsightWidgetPlaceholderCoordinates = createSelector(selectInsightWidgetPlaceholder, selectLayout, function (widgetPlaceholder, layout) {
    return widgetPlaceholder ? getWidgetCoordinates(layout, widgetPlaceholder.ref) : undefined;
});
/**
 * @internal
 */
export var selectKpiWidgetPlaceholder = createSelector(selectAllCustomWidgets, function (customWidgets) {
    return customWidgets.find(isKpiPlaceholderWidget);
});
/**
 * @internal
 */
export var selectKpiWidgetPlaceholderCoordinates = createSelector(selectKpiWidgetPlaceholder, selectLayout, function (widgetPlaceholder, layout) {
    return widgetPlaceholder ? getWidgetCoordinates(layout, widgetPlaceholder.ref) : undefined;
});
