...
import { ObjRef, VisualizationProperties, IDashboardFilterReference, InsightDrillDefinition, IDashboardLayout, IDashboardLayoutSectionHeader, IKpiComparisonDirection, IKpiComparisonTypeComparison, IDrillToLegacyDashboard } from "@gooddata/sdk-model";
...
declare type changeItemsHeightActionPayload = {
    sectionIndex: number;
    itemIndexes: number[];
    height: number;
};
declare type changeItemWidthActionPayload = {
    sectionIndex: number;
    itemIndex: number;
    width: number;
};
...
declare type ReplaceKpiWidgetDrill = {
    ref: ObjRef;
...
export declare const layoutReducers: {
    ...
    replaceKpiWidgetDrill: CaseReducer<LayoutState, {
        payload: import("../_infra/undoEnhancer").UndoPayload<import("../..").IDashboardCommand> & ReplaceKpiWidgetDrill;
        type: string;
    }>;
    ...
    changeItemsHeight: CaseReducer<LayoutState, {
        payload: changeItemsHeightActionPayload;
        type: string;
    }>;
    changeItemWidth: CaseReducer<LayoutState, {
        payload: changeItemWidthActionPayload;
        type: string;
    }>;
};
export {};
