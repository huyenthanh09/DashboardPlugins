...
var changeItemsHeight = function (state, action) {
    invariant(state.layout);
    var _a = action.payload, sectionIndex = _a.sectionIndex, itemIndexes = _a.itemIndexes, height = _a.height;
    var section = state.layout.sections[sectionIndex];
    itemIndexes.forEach(function (itemIndex) {
        var item = section.items[itemIndex];
        var newSize = __assign(__assign({}, item.size), { xl: __assign(__assign({}, item.size.xl), { gridHeight: height }) });
        item.size = newSize;
    });
};
var changeItemWidth = function (state, action) {
    invariant(state.layout);
    var _a = action.payload, sectionIndex = _a.sectionIndex, itemIndex = _a.itemIndex, width = _a.width;
    var section = state.layout.sections[sectionIndex];
    var item = section.items[itemIndex];
    var newSize = __assign(__assign({}, item.size), { xl: __assign(__assign({}, item.size.xl), { gridWidth: width }) });
    item.size = newSize;
};
...
var getWidgetByRef = function (state, widgetRef) {
    ...
    return allWidgets.find(function (w) {
...
var replaceKpiWidgetDrill = function (state, action) {
    invariant(state.layout);
    var _a = action.payload, ref = _a.ref, drill = _a.drill;
    var widget = getWidgetByRef(state, ref);
    invariant(widget && isKpiWidget(widget));
