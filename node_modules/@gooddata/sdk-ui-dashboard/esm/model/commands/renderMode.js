 ...
 * @internal
 */
export function changeRenderMode(renderMode, renderModeChangeOptions, correlationId) {
    if (renderModeChangeOptions === void 0) { renderModeChangeOptions = { resetDashboard: true }; }
    return {
        type: "GDC.DASH/CMD.CHANGE_RENDER_MODE",
        correlationId: correlationId,
        payload: {
            renderMode: renderMode,
            renderModeChangeOptions: renderModeChangeOptions,
        },
    };
}
/**
