...
export declare const useDashboardCommandProcessing: <TCommand extends DashboardCommands, TCommandCreatorArgs extends any[], TSuccessEventType extends DashboardEventType, TErrorEventType extends DashboardEventType>({ commandCreator, successEvent, errorEvent, onSuccess, onError, onBeforeRun, }: {
    ...
    onSuccess?: ((event: Extract<import("../events").DashboardCommandStarted<any>, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardCommandFailed<any>, {
        type: TSuccessEventType;
        ...
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardInitialized, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardDeinitialized, {
        type: TSuccessEventType;
        ...
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardExportToPdfRequested, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardExportToPdfResolved, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardSharingChanged, {
        type: TSuccessEventType;
        ...
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardKpiWidgetDrillRemoved, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardKpiWidgetDrillSet, {
        type: TSuccessEventType;
        ...
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardInsightWidgetExportRequested, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardInsightWidgetExportResolved, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardInsightWidgetRefreshed, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardWidgetExecutionStarted, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardWidgetExecutionFailed, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardWidgetExecutionSucceeded, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardAlertCreated, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardAlertsRemoved, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardAlertUpdated, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardScheduledEmailCreated, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardScheduledEmailSaved, {
        type: TSuccessEventType;
        ...
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardDrillableItemsChanged, {
        type: TSuccessEventType;
    }> | Extract<import("../events").DashboardRenderModeChanged, {
        type: TSuccessEventType;
    }>) => void) | undefined;
    onError?: ((event: Extract<import("../events").DashboardCommandStarted<any>, {
