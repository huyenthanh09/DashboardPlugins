...
export var useInitializeDashboardStore = function (props) {
    ...
    var mapboxToken = useMapboxToken((_a = props.config) === null || _a === void 0 ? void 0 : _a.mapboxToken);
    var _c = (_b = useClientWorkspaceIdentifiers()) !== null && _b !== void 0 ? _b : {}, clientId = _c.client, dataProductId = _c.dataProduct;
    var _d = __read(useState(null), 2), dashboardStore = _d[0], setDashboardStore = _d[1];
    ...
    useEffect(function () {
        ...
        if (!objectUtils.shallowEqualObjects(previousInitProps, currentInitProps) || !dashboardStore) {
            ...
            newDashboardStore.store.dispatch(initializeDashboard(enrichMapboxToken(props.config, mapboxToken), props.permissions, InitialLoadCorrelationId));
