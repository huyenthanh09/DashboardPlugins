...
export declare const useDashboardCommand: <TCommand extends DashboardCommands, TArgs extends any[]>(commandCreator: (...args: TArgs) => TCommand, eventHandlers?: {
    "GDC.DASH/EVT.COMMAND.FAILED"?: ((event: import("../events").DashboardCommandFailed<any>) => void) | undefined;
    "GDC.DASH/EVT.COMMAND.REJECTED"?: ((event: import("../events").DashboardCommandRejected) => void) | undefined;
    "GDC.DASH/EVT.COMMAND.STARTED"?: ((event: import("../events").DashboardCommandStarted<any>) => void) | undefined;
    ...
    "GDC.DASH/EVT.INITIALIZED"?: ((event: import("../events").DashboardInitialized) => void) | undefined;
    "GDC.DASH/EVT.DEINITIALIZED"?: ((event: import("../events").DashboardDeinitialized) => void) | undefined;
    ...
    "GDC.DASH/EVT.RENDER_MODE.CHANGED"?: ((event: import("../events").DashboardRenderModeChanged) => void) | undefined;
    "GDC.DASH/EVT.EXPORT.PDF.REQUESTED"?: ((event: import("../events").DashboardExportToPdfRequested) => void) | undefined;
    "GDC.DASH/EVT.EXPORT.PDF.RESOLVED"?: ((event: import("../events").DashboardExportToPdfResolved) => void) | undefined;
    ...
    "GDC.DASH/EVT.KPI_WIDGET.DRILL_REMOVED"?: ((event: import("../events").DashboardKpiWidgetDrillRemoved) => void) | undefined;
    "GDC.DASH/EVT.KPI_WIDGET.DRILL_SET"?: ((event: import("../events").DashboardKpiWidgetDrillSet) => void) | undefined;
    ...
    "GDC.DASH/EVT.INSIGHT_WIDGET.EXPORT_REQUESTED"?: ((event: import("../events").DashboardInsightWidgetExportRequested) => void) | undefined;
    "GDC.DASH/EVT.INSIGHT_WIDGET.EXPORT_RESOLVED"?: ((event: import("../events").DashboardInsightWidgetExportResolved) => void) | undefined;
    "GDC.DASH/EVT.INSIGHT_WIDGET.REFRESHED"?: ((event: import("../events").DashboardInsightWidgetRefreshed) => void) | undefined;
    "GDC.DASH/EVT.WIDGET.EXECUTION_STARTED"?: ((event: import("../events").DashboardWidgetExecutionStarted) => void) | undefined;
    "GDC.DASH/EVT.WIDGET.EXECUTION_FAILED"?: ((event: import("../events").DashboardWidgetExecutionFailed) => void) | undefined;
    "GDC.DASH/EVT.WIDGET.EXECUTION_SUCCEEDED"?: ((event: import("../events").DashboardWidgetExecutionSucceeded) => void) | undefined;
    ...
    "GDC.DASH/EVT.ALERTS.REMOVED"?: ((event: import("../events").DashboardAlertsRemoved) => void) | undefined;
    "GDC.DASH/EVT.SCHEDULED_EMAIL.CREATED"?: ((event: import("../events").DashboardScheduledEmailCreated) => void) | undefined;
    "GDC.DASH/EVT.SCHEDULED_EMAIL.SAVED"?: ((event: import("../events").DashboardScheduledEmailSaved) => void) | undefined;
    ...
    "GDC.DASH/EVT.DRILL.DRILLABLE_ITEMS.CHANGED"?: ((event: import("../events").DashboardDrillableItemsChanged) => void) | undefined;
    ...
    "GDC.DASH/EVT.SHARING.CHANGED"?: ((event: import("../events").DashboardSharingChanged) => void) | undefined;
