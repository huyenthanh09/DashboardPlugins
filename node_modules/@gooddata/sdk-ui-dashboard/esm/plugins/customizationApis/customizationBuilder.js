...
var DashboardCustomizationBuilder = /** @class */ (function () {
    function DashboardCustomizationBuilder() {
        ...
        this.sealCustomizers = function () {
            ...
            _this.filtersCustomizer.sealCustomizer();
        ...
        this.filters = function () {
            return _this.filtersCustomizer;
        };
        ...
        this.build = function () {
            ...
            var props = __assign({ InsightComponentProvider: _this.insightCustomizer.getInsightProvider(), InsightBodyComponentProvider: _this.insightCustomizer.getInsightBodyComponentProvider(), KpiComponentProvider: _this.kpiCustomizer.getKpiProvider(), WidgetComponentProvider: _this.widgetCustomizer.getWidgetComponentProvider(), DashboardAttributeFilterComponentProvider: _this.filtersCustomizer
                    .attribute()
                    .getAttributeFilterProvider(), DashboardDateFilterComponentProvider: _this.filtersCustomizer.date().getDateFilterProvider(), customizationFns: {
