...
var InsightRendererCore = /** @class */ (function (_super) {
    ...
    function InsightRendererCore() {
        ...
        _this.updateVisualization = function () {
            ...
            var insight = fillMissingFormats(ignoreTitlesForSimpleMeasures(fillMissingTitles(_this.props.insight, _this.props.locale)));
            _this.visualization.update(visProps, insight, {}, _this.getExecutionFactory());
        };
        _this.setupVisualization = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                this.visualization = visualizationFactory({
                    ...
                    configPanelElement: function () {
                        var _a, _b;
                        var rootNode = (_b = (_a = _this.containerRef.current) === null || _a === void 0 ? void 0 : _a.getRootNode()) !== null && _b !== void 0 ? _b : document;
                    ...
                    element: function () {
                        var _a, _b;
                        var rootNode = (_b = (_a = _this.containerRef.current) === null || _a === void 0 ? void 0 : _a.getRootNode()) !== null && _b !== void 0 ? _b : document;
                        return rootNode.querySelector("#" + _this.elementId);
                    },
