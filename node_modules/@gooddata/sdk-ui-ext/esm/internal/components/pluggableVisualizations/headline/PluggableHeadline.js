...
var PluggableHeadline = /** @class */ (function (_super) {
    ...
    PluggableHeadline.prototype.getExecution = function (options, insight, executionFactory) {
    ...
    PluggableHeadline.prototype.renderVisualization = function (options, insight, executionFactory) {
        ...
        var locale = options.locale, _a = options.custom, custom = _a === void 0 ? {} : _a, config = options.config, customVisualizationConfig = options.customVisualizationConfig;
