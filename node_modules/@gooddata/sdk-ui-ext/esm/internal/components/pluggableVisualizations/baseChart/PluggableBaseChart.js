...
var PluggableBaseChart = /** @class */ (function (_super) {
    ...
    PluggableBaseChart.prototype.getInsightWithDrillDownApplied = function (source, drillDownContext, backendSupportsElementUris) {
        var intersection = drillDownContext.event.drillContext.intersection;
        var withFilters = addIntersectionFiltersToInsight(source, intersection, backendSupportsElementUris);
    ...
    PluggableBaseChart.prototype.getExecution = function (options, insight, executionFactory) {
        ...
        return (_a = (_b = executionFactory
            ...
            .withSorting.apply(_a, createSorts(this.type, insight, supportedControls, this.featureFlags)).withDateFormat(dateFormat)
    ...
    PluggableBaseChart.prototype.buildVisualizationConfig = function (options, supportedControls) {
        ...
        var validColorMapping = compact(colorMapping).map(function (mapItem) { return ({
    ...
    PluggableBaseChart.prototype.getSupportedControls = function (insight, options) {
        ...
        var supportedControls = this.environment === DASHBOARDS_ENVIRONMENT
    ...
    PluggableBaseChart.prototype.reuseCurrentSort = function (previousAvailableSorts, properties, availableSorts, defaultSort) {
        var previousSort = properties === null || properties === void 0 ? void 0 : properties.sortItems;
