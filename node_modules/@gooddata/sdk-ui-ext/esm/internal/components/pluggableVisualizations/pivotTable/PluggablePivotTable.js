...
var PluggablePivotTable = /** @class */ (function (_super) {
    ...
    PluggablePivotTable.prototype.getInsightWithDrillDownApplied = function (sourceVisualization, drillDownContext, backendSupportsElementUris) {
        var drillDownInsight = modifyBucketsAttributesForDrillDown(sourceVisualization, drillDownContext.drillDefinition);
        var drillDownInsightWithFilters = addIntersectionFiltersToInsight(drillDownInsight, drillDownContext.event.drillContext.intersection, backendSupportsElementUris);
    ...
    PluggablePivotTable.prototype.renderVisualization = function (options, insight, executionFactory) {
        ...
        if (this.environment === DASHBOARDS_ENVIRONMENT) {
            ...
            this.renderFun(React.createElement(CorePivotTable, __assign({}, pivotTableProps)), this.getElement());
        }
    };
