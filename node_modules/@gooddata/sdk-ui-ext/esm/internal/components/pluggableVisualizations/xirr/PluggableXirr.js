...
var PluggableXirr = /** @class */ (function (_super) {
    ...
    function PluggableXirr(props) {
        ...
        _this.pushData = function (data, options) {
            ...
            var filterAttributes = _this.withEmptyAttributeTargets(data);
            _this.superPushData(filterAttributes, options);
        };
    ...
    PluggableXirr.prototype.getExecution = function (options, insight, executionFactory) {
        var _a;
    ...
    PluggableXirr.prototype.renderVisualization = function (options, insight, executionFactory) {
        var locale = options.locale, _a = options.custom, custom = _a === void 0 ? {} : _a, config = options.config;
    ...
    PluggableXirr.prototype.getXirrDimensions = function (insight) {
        var attributeBucket = insightBucket(insight, BucketNames.ATTRIBUTE);
        var attributes = attributeBucket ? bucketAttributes(attributeBucket) : [];
        return [newDimension(__spreadArrays([MeasureGroupIdentifier], attributes))];
    };
