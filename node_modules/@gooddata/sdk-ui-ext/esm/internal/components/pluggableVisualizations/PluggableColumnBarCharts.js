...
var PluggableColumnBarCharts = /** @class */ (function (_super) {
    ...
    PluggableColumnBarCharts.prototype.getExtendedReferencePoint = function (referencePoint) {
        ...
        return _super.prototype.getExtendedReferencePoint.call(this, referencePoint).then(function (ext) {
            ...
            if (_this.featureFlags.enableSeparateTotalLabels) {
    ...
    PluggableColumnBarCharts.prototype.addFiltersForColumnBar = function (source, drillConfig, event, backendSupportsElementUris) {
    ...
    PluggableColumnBarCharts.prototype.getInsightWithDrillDownApplied = function (source, drillDownContext, backendSupportsElementUris) {
        var withFilters = this.addFiltersForColumnBar(source, drillDownContext.drillDefinition, drillDownContext.event, backendSupportsElementUris);
