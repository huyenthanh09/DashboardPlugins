...
var InputControl = /** @class */ (function (_super) {
    ...
    InputControl.prototype.UNSAFE_componentWillReceiveProps = function (newProps) {
    ...
    InputControl.prototype.render = function () {
        ...
        return (React.createElement(DisabledBubbleMessage, { showDisabledMessage: showDisabledMessage },
            React.createElement("label", { className: "adi-bucket-inputfield gd-input gd-input-small" },
                ...
                React.createElement("input", { ref: function (input) { return (_this.inputRef = input); }, className: this.getInputClassNames(), value: this.state.value, placeholder: getTranslation(placeholder, intl), disabled: disabled, onKeyPress: this.onKeyPress, onBlur: this.onBlur, onChange: this.onValueChanged, maxLength: type === "number" ? MAX_NUMBER_LENGTH : null }))));
    };
