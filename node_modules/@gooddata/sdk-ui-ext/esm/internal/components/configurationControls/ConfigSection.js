...
var ConfigSection = /** @class */ (function (_super) {
    ...
    ConfigSection.prototype.renderToggleSwitch = function () {
        if (this.props.canBeToggled) {
            var _a = this.props, toggledOn = _a.toggledOn, toggleDisabled = _a.toggleDisabled, showDisabledMessage = _a.showDisabledMessage, id = _a.id;
