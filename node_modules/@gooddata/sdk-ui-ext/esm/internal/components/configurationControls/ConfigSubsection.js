...
var ConfigSubsection = /** @class */ (function (_super) {
    ...
    ConfigSubsection.prototype.renderToggleSwitch = function () {
        if (this.props.canBeToggled) {
            var _a = this.props, toggledOn = _a.toggledOn, toggleDisabled = _a.toggleDisabled, showDisabledMessage = _a.showDisabledMessage, title = _a.title, intl = _a.intl, axisType = _a.axisType;
