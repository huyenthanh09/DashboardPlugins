...
var BaseChartConfigurationPanel = /** @class */ (function (_super) {
    ...
    BaseChartConfigurationPanel.prototype.renderCanvasSection = function () {
        ...
        var _c = this.props, properties = _c.properties, propertiesMeta = _c.propertiesMeta, pushData = _c.pushData, featureFlags = _c.featureFlags, insight = _c.insight;
        var controlsDisabled = this.isControlDisabled();
        var buckets = insight.insight.buckets;
        var stackBy = bucketsById(buckets, BucketNames.STACK);
        var isNotStacked = isEmpty(stackBy);
    ...
    BaseChartConfigurationPanel.prototype.getBaseChartAxisSection = function (axes) {
        ...
        var isAxisNameViewByTwoAttributesEnabled = featureFlags.enableAxisNameViewByTwoAttributes;
        return axes.map(function (axis) {
            var disabled = controlsDisabled || (!axis.primary && !isViewedBy);
            var nameSubsectionDisabled = (axis.primary || !isAxisNameViewByTwoAttributesEnabled) && itemsOnAxes[axis.name] > 1;
            ...
            return (React.createElement(ConfigSection, { key: name, id: name + "_section", title: title, subtitle: subtitle, valuePath: name + ".visible", canBeToggled: true, toggledOn: visible, toggleDisabled: controlsDisabled, propertiesMeta: propertiesMeta, properties: properties, pushData: pushData },
                isNameSubsectionVisible && (React.createElement(NameSubsection, { disabled: disabled || nameSubsectionDisabled, configPanelDisabled: controlsDisabled, axis: axis.name, properties: properties, pushData: pushData })),
