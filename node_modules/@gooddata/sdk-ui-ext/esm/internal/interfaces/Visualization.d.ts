...
export declare type RenderFunction = (component: any, target: Element) => void;
export declare type ElementSelectorFunction = () => HTMLElement | null;
/** @deprecated Use ElementSelectorFunction instead */
export declare type ElementSelectorString = string;
...
export declare type IBucketFilter = IAttributeFilter | IDateFilter | IMeasureValueFilter | IRankingFilter;
 ...
 * @alpha
 */
export declare type PluggableVisualizationError = InvalidBucketsSdkError | EmptyAfmSdkError;
/**
 * @alpha
 */
