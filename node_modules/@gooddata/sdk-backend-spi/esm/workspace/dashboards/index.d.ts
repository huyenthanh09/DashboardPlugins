import { IFilter, ObjRef, FilterContextItem, IFilterContextDefinition, IWidgetAlert, IWidgetAlertDefinition, IWidget, ObjectType, CatalogItem, IScheduledMail, IScheduledMailDefinition, IInsight, IDashboardPlugin, IDashboard, IListedDashboard, IDashboardDefinition, IDashboardPluginDefinition } from "@gooddata/sdk-model";
/**
 ...
 * @alpha
 */
export declare type SupportedWidgetReferenceTypes = Exclude<ObjectType, "fact" | "attribute" | "displayForm" | "dataSet" | "tag" | "insight" | "variable" | "colorPalette">;
/**
