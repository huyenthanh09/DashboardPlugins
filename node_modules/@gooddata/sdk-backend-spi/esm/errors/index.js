...
var NotAuthenticated = /** @class */ (function (_super) {
    ...
    function NotAuthenticated(message, cause, reason) {
        var _this = _super.call(this, message, AnalyticalBackendErrorTypes.NOT_AUTHENTICATED, cause) || this;
        _this.reason = reason;
        return _this;
    }
 ...
 * @public
 */
var LimitReached = /** @class */ (function (_super) {
    __extends(LimitReached, _super);
    function LimitReached(message, cause) {
        return _super.call(this, message, AnalyticalBackendErrorTypes.LIMIT_REACHED, cause) || this;
    }
    return LimitReached;
}(AnalyticalBackendError));
export { LimitReached };
 ...
 * @public
 */
var ContractExpired = /** @class */ (function (_super) {
    __extends(ContractExpired, _super);
    function ContractExpired(message, cause) {
        return _super.call(this, message, AnalyticalBackendErrorTypes.CONTRACT_EXPIRED, cause) || this;
    }
    return ContractExpired;
}(AnalyticalBackendError));
export { ContractExpired };
/**
