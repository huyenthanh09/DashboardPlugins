...
export function getGeoData(dv, emptyHeaderString, nullHeaderString) {
    ...
    if (locationIndex !== undefined) {
        var locationData = getAttributeData(attributeHeaderItems, locationIndex, emptyHeaderString, nullHeaderString);
...
function getAttributeData(attributeHeaderItems, dataIndex, emptyHeaderString, nullHeaderString) {
    var headerItems = attributeHeaderItems[dataIndex];
    return headerItems.map(function (i) {
        var name = resultHeaderName(i);
        if (name) {
            return name;
        }
...
export function getAvailableLegends(categoryItems, geoData) {
    ...
    var hasCategoryLegend = Boolean(categoryItems === null || categoryItems === void 0 ? void 0 : categoryItems.length);
...
export function findGeoAttributesInDimension(dv, geoData) {
    ...
    var segmentByAttribute = (segment === null || segment === void 0 ? void 0 : segment.data.length) ? __assign(__assign({}, attributeDescriptors[segment.index].attributeHeader), { items: attributeResultHeaderItems[segment.index] }) : undefined;
    var tooltipTextAttribute = (tooltipText === null || tooltipText === void 0 ? void 0 : tooltipText.data.length) ? __assign(__assign({}, attributeDescriptors[tooltipText.index].attributeHeader), { items: attributeResultHeaderItems[tooltipText.index] }) : undefined;
    return {
