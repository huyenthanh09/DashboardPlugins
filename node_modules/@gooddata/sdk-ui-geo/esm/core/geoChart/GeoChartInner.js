...
var GeoChartInner = /** @class */ (function (_super) {
    ...
    GeoChartInner.prototype.render = function () {
        ...
        return (React.createElement(Measure, { client: true }, function (_a) {
            ...
            return _this.renderVisualizationContent(measureRef, (_b = contentRectClient === null || contentRectClient === void 0 ? void 0 : contentRectClient.height) !== null && _b !== void 0 ? _b : 0, contentRect);
        }));
    };
    ...
    GeoChartInner.prototype.getChartProps = function (geoChartOptions) {
        ...
        if (segmentIndex) {
            var selectedSegmentItems = categoryItems
                .filter(function (item) { return item.isVisible; })
                .map(function (item) { return item.uri; });
