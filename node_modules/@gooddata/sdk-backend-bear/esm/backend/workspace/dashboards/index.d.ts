import { IWorkspaceDashboardsService, IWidgetAlertCount, SupportedWidgetReferenceTypes, IWidgetReferences, IDashboardWithReferences, IGetDashboardOptions, SupportedDashboardReferenceTypes, IDashboardReferences, IGetScheduledMailOptions } from "@gooddata/sdk-backend-spi";
import { IFilter, ObjRef, FilterContextItem, IFilterContextDefinition, IWidgetAlert, IWidgetAlertDefinition, IWidget, IScheduledMail, IScheduledMailDefinition, IDashboard, IDashboardDefinition, IListedDashboard, IDashboardPlugin, IDashboardPluginDefinition } from "@gooddata/sdk-model";
...
export declare class BearWorkspaceDashboards implements IWorkspaceDashboardsService {
    ...
    updateScheduledMail: (ref: ObjRef, scheduledMailDefinition: IScheduledMailDefinition, filterContextRef?: import("@gooddata/sdk-model").UriRef | import("@gooddata/sdk-model").IdentifierRef | undefined) => Promise<void>;
