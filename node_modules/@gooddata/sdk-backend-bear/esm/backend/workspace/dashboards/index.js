...
var BearWorkspaceDashboards = /** @class */ (function () {
    function BearWorkspaceDashboards(authCall, workspace) {
        ...
        this.getDashboards = function (options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var explicitlySharedDashboardsObjectLinks, accessibleDashboardsObjectLinks, userMap, _a;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            explicitlySharedDashboardsObjectLinks = _b.sent();
                            return [4 /*yield*/, this.getAccessibleDashboards(explicitlySharedDashboardsObjectLinks, !!options.includeAvailableViaLink)];
                        case 2:
                            accessibleDashboardsObjectLinks = _b.sent();
                            if (!options.loadUserData) return [3 /*break*/, 4];
                            return [4 /*yield*/, updateUserMap(new Map(), compact(flatMap(accessibleDashboardsObjectLinks, function (link) { return [link.author, link.contributor]; })), this.authCall)];
                        case 3:
                            _a = _b.sent();
                            return [3 /*break*/, 5];
                        case 4:
                        ...
                        case 5:
                            userMap = _a;
                            return [2 /*return*/, accessibleDashboardsObjectLinks.map(function (link) {
                                    var availability = _this.isExplicitlyShared(link, explicitlySharedDashboardsObjectLinks)
                                        ? "full"
                                        : "viaLink";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        convertedFilters = filters === null || filters === void 0 ? void 0 : filters.map(fromSdkModel.convertFilterContextItem);
        ...
        this.updateScheduledMail = function (ref, scheduledMailDefinition, filterContextRef) { return __awaiter(_this, void 0, void 0, function () {
            var scheduledMailWithFilterContext, convertedScheduledMail;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        scheduledMailWithFilterContext = __assign(__assign({}, scheduledMailDefinition), { attachments: scheduledMailDefinition.attachments.map(function (attachment) { return (__assign(__assign({}, attachment), { filterContext: filterContextRef })); }) });
                        convertedScheduledMail = fromSdkModel.convertScheduledMail(scheduledMailWithFilterContext);
                        return [4 /*yield*/, this.updateBearMetadataObject(ref, convertedScheduledMail)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.deleteScheduledMail = function (scheduledMailRef) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.deleteBearMetadataObject(scheduledMailRef)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.getScheduledMailsForDashboard = function (dashboardRef, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var createdByCurrentUser, scheduledMailObjectLinks, _a, userMap, wrappedScheduledMails;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            createdByCurrentUser = options.createdByCurrentUser;
                            if (!createdByCurrentUser) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.getScheduledMailObjectLinksForDashboardAndCurrentUser(dashboardRef)];
                        case 1:
                            _a = _b.sent();
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, this.getScheduledMailObjectLinksForDashboard(dashboardRef)];
                        case 3:
                            _a = _b.sent();
                            _b.label = 4;
                        case 4:
                            scheduledMailObjectLinks = _a;
                            userMap = new Map();
                            if (!options.loadUserData) return [3 /*break*/, 7];
                            return [4 /*yield*/, updateUserMap(userMap, compact(flatMap(scheduledMailObjectLinks, function (link) { return [link.author, link.contributor]; })), this.authCall)];
                        case 5:
                            userMap = _b.sent();
                            if (!(userMap.values.length === 0)) return [3 /*break*/, 7];
                            return [4 /*yield*/, this.authCall(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
                                    var profile, user;
                                    var _a, _b;
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            case 0: return [4 /*yield*/, sdk.user.getCurrentProfile()];
                                            case 1:
                                                profile = _c.sent();
                                                user = convertUser(profile);
                        ...
                        case 6:
                            _b.sent();
                            _b.label = 7;
                        case 7: return [4 /*yield*/, this.authCall(function (sdk) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, sdk.md.getObjects(this.workspace, scheduledMailObjectLinks.map(function (_a) {
                                            var link = _a.link;
                                            return link;
                                        }))];
                                });
                        ...
                        case 8:
                            wrappedScheduledMails = _b.sent();
                            return [2 /*return*/, wrappedScheduledMails.map(function (scheduledMail) {
                                    return toSdkModel.convertScheduledMail(scheduledMail, userMap);
                                })];
                    }
                });
            });
        ...
        this.getScheduledMailsCountForDashboard = function (dashboardRef) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getScheduledMailObjectLinksForDashboard(dashboardRef)];
                    case 1:
                        objectLinks = _a.sent();
        ...
        this.getAccessibleDashboards = function (explicitlySharedDashboardsObjectLinks, includeAvailableViaLink) { return __awaiter(_this, void 0, void 0, function () {
            var allDashboardsObjectLinks;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!includeAvailableViaLink) {
                            return [2 /*return*/, explicitlySharedDashboardsObjectLinks];
                        }
                        return [4 /*yield*/, this.authCall(function (sdk) {
                                return sdk.md.getAnalyticalDashboards(_this.workspace, true);
                            })];
                    case 1:
                        allDashboardsObjectLinks = _a.sent();
                        return [2 /*return*/, allDashboardsObjectLinks.filter(function (dashboard) {
                                var _a;
                                return (_this.isExplicitlyShared(dashboard, explicitlySharedDashboardsObjectLinks) ||
        ...
        // Scheduled mail
        this.getScheduledMailObjectLinksForDashboard = function (dashboardRef) { return __awaiter(_this, void 0, void 0, function () {
            var dashboardUri;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        this.getScheduledMailObjectLinksForDashboardAndCurrentUser = function (dashboardRef) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.authCall(function (_sdk, context) { return __awaiter(_this, void 0, void 0, function () {
                        var user, objectLinks;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, userUriFromAuthenticatedPrincipalWithAnonymous(context.getPrincipal)];
                                case 1:
                                    ...
                                    return [4 /*yield*/, this.getScheduledMailObjectLinksForDashboard(dashboardRef)];
                                case 2:
                                    objectLinks = _a.sent();
                                    return [2 /*return*/, objectLinks.filter(function (_a) {
    ...
    BearWorkspaceDashboards.prototype.isExplicitlyShared = function (dashboard, explicitlySharedDashboards) {
        return explicitlySharedDashboards.some(function (_a) {
            var link = _a.link;
            return link === dashboard.link;
        });
    };
