...
var UserModule = /** @class */ (function () {
    ...
    UserModule.prototype.logout = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isLoggedIn, bootstrapResource, userUri, userId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.xhr.getParsed("/gdc/app/account/bootstrap")];
                    case 2:
                        bootstrapResource = (_a.sent()).bootstrapResource;
                        userUri = bootstrapResource.accountSetting.links.self;
                        userId = userUri.match(/([^/]+)\/?$/)[1];
                        return [2 /*return*/, this.xhr.del("/gdc/account/login/" + userId)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    UserModule.prototype.getAccountInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.xhr.getParsed("/gdc/app/account/bootstrap")];
                    case 1:
                        bootstrapResource = (_a.sent()).bootstrapResource;
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        bootstrapResource = (_a.sent()).bootstrapResource;
                        return [2 /*return*/, bootstrapResource.current.featureFlags];
                }
            });
        });
    };
