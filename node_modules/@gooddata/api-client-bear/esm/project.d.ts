...
export declare class ProjectModule {
     ...
     * @returns Project
     */
    getProject(projectId: string): Promise<GdcUser.IProject>;
    /**
     ...
     */
    getProjects(profileId: string): Promise<GdcUser.IProject[]>;
    /**
     ...
     */
    getProjectsWithPaging(userId: string, offset: number, limit: number, search?: string): Promise<GdcProject.IUserProjectsResponse>;
    /**
     ...
     */
    getUserListWithPaging(projectId: string, options: GdcUser.IGetUserListParams): Promise<GdcUser.IGetUserListResponse>;
    /**
     * Get full user list
     *
     * @param projectId - project identifier
     ...
     */
    getUserList(projectId: string, options: Omit<GdcUser.IGetUserListParams, "offset" | "limit">): Promise<GdcUser.IUserListItem[]>;
    /**
     ...
     */
    getUserGroups(projectId: string, options: GdcUserGroup.IGetUserGroupsParams): Promise<GdcUserGroup.IGetUserGroupsResponse>;
    /**
     ...
     */
    getGranteesInfo(objectUri: string, options: GdcAccessControl.IGetGranteesParams): Promise<GdcAccessControl.IGetGranteesResponse>;
