...
export declare class UserModule {
     ...
     */
    getCurrentProfile(): Promise<GdcUser.IAccountSetting>;
    /**
     * Gets user's regional number formatting configuration
     * @param userId - loginMD5
     * @returns Resolves with separators setting object
     */
    getUserRegionalNumberFormatting(userId: string): Promise<GdcUser.ISeparators>;
    /**
     ...
     */
    getFeatureFlags(): Promise<GdcUser.IFeatureFlags>;
    /**
